...
subject_stack:
  entry_subject: 索引
  visual_subject: 10 章 × 3 語のミニ索引を 2 段組の表で配置。章ラベルは見出し風に太く
...
main_symbols: 10 章 × 3 語のミニ索引を 2 段組の表で配置。章ラベルは見出し風に太く
...
Subject: The entry subject is 索引, but the visual subject is 10 章 × 3 語のミニ索引を 2 段組の表で配置。章ラベルは見出し風に太く. Show generic cards, arrows, simple UI-neutral symbols only as supporting elements.
