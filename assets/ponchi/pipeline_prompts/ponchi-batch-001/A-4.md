...
subject_stack:
  ...
  visual_subject: ●／◐／○ の 3 つの記号を縦に並べ、各行に 1 文ずつ説明
...
main_symbols: ●／◐／○ の 3 つの記号を縦に並べ、各行に 1 文ずつ説明
...
Subject: The entry subject is 体験区分の凡例, but the visual subject is ●／◐／○ の 3 つの記号を縦に並べ、各行に 1 文ずつ説明. Show generic cards, arrows, simple UI-neutral symbols only as supporting elements.
