...
subject_stack:
  entry_subject: 略称表記
  visual_subject: 略称／正式名称／読み／初出ページの 4 列表を縦に並べる
...
main_symbols: 略称／正式名称／読み／初出ページの 4 列表を縦に並べる
...
Subject: The entry subject is 略称表記, but the visual subject is 略称／正式名称／読み／初出ページの 4 列表を縦に並べる. Show generic cards, arrows, simple UI-neutral symbols only as supporting elements.
