# H-51 Preview から正式版への流れ ponchi prompt
...
subject_stack:
  entry_subject: Preview から正式版への流れ
...
scene_goal: make Preview から正式版への流れ understandable as a simple book diagram
main_symbols: A preview-to-stable release flow: rough preview cards pass through feedback, fixes, and confidence gates before becoming a polished stable release card.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for H-51 Preview から正式版への流れ.

Subject: The entry subject is Preview から正式版への流れ, but the visual subject is A preview-to-stable release flow: rough preview cards pass through feedback, fixes, and confidence gates before becoming a polished stable release card.. Show Users send feedback cards back into the process; no product names, no official icons, no readable release labels. only as supporting elements.
