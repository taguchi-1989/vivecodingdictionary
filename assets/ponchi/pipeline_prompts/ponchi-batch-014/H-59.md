# H-59 AI エージェント元年 ponchi prompt
...
scene_goal: make AI エージェント元年 understandable as a simple book diagram
main_symbols: An AI-agent era map: simple assistants evolve into tool-using agents, multi-step workflows, and coordinated agent teams around a central year-change milestone.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for H-59 AI エージェント元年.

Subject: The entry subject is AI エージェント元年, but the visual subject is An AI-agent era map: simple assistants evolve into tool-using agents, multi-step workflows, and coordinated agent teams around a central year-change milestone.. Show A user watches task cards move from one-step answers to autonomous action loops; no product logos, no readable year text, no chat UI. only as supporting elements.
