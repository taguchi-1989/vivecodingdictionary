# H-56 Claude のバージョン史 ponchi prompt
...
scene_goal: make Claude のバージョン史 understandable as a simple book diagram
main_symbols: A model-version history timeline: successive assistant model cards become larger and more specialized over time, with tiers and capability bars shown as abstract blocks.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for H-56 Claude のバージョン史.

Subject: The entry subject is Claude のバージョン史, but the visual subject is A model-version history timeline: successive assistant model cards become larger and more specialized over time, with tiers and capability bars shown as abstract blocks.. Show An engineer points at a neutral timeline of versions and comparison gauges; no Claude or Anthropic logo, no model names, no readable dates. only as supporting elements.
