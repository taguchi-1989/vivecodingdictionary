# H-52 Copilot から Claude Code までの流れ ponchi prompt
...
subject_stack:
  entry_subject: Copilot から Claude Code までの流れ
...
scene_goal: make Copilot から Claude Code までの流れ understandable as a simple book diagram
main_symbols: A coding-assistant evolution timeline: early autocomplete help grows into chat assistance, then into agentic coding workflows across generic editor-like workspaces.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for H-52 Copilot から Claude Code までの流れ.

Subject: The entry subject is Copilot から Claude Code までの流れ, but the visual subject is A coding-assistant evolution timeline: early autocomplete help grows into chat assistance, then into agentic coding workflows across generic editor-like workspaces.. Show A developer watches coding help become more capable over time; no GitHub, Copilot, Claude, OpenAI, or editor logos; no product UI. only as supporting elements.
