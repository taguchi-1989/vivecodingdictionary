...
scene_goal: make GitHub MCP understandable as a simple book diagram
main_symbols: A repository-service connector: a client routes issue, pull-request, and file-operation cards through a central server into a generic repository workspace.
...
Subject: The entry subject is GitHub MCP, but the visual subject is A repository-service connector: a client routes issue, pull-request, and file-operation cards through a central server into a generic repository workspace.. Show Use generic branch, checklist, comment, and file cards; no GitHub logo, no Octocat, no real repository UI, no readable PR text. only as supporting elements.
