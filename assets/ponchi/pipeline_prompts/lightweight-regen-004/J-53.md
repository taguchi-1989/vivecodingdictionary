# J-53 著作権法 30 条の 4（日本） ponchi prompt
...
scene_goal: make 著作権法 30 条の 4（日本） understandable as a simple book diagram
main_symbols: A copyright-law training-data decision map: source material cards flow through legal condition gates into allowed analysis, restricted use, or review paths.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for J-53 著作権法 30 条の 4（日本）.

Subject: The entry subject is 著作権法 30 条の 4（日本）, but the visual subject is A copyright-law training-data decision map: source material cards flow through legal condition gates into allowed analysis, restricted use, or review paths.. Show Show document stacks, legal balance, and jurisdiction-neutral compliance arrows; no readable statute text, no official marks. only as supporting elements.
