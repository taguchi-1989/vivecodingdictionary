...
main_symbols: A UI-generation assistant base scene: prompt cards become layout blocks, component panels, and preview screens, leaving a clean blank logo area in the upper right.
...
Subject: The entry subject is v0, but the visual subject is A UI-generation assistant base scene: prompt cards become layout blocks, component panels, and preview screens, leaving a clean blank logo area in the upper right.. Show Use generic web-layout blocks only; no v0 logo, no Vercel mark, no readable UI text, no product UI. only as supporting elements.
