# H-63 Vibe Coding 命名 ponchi prompt
...
scene_goal: make Vibe Coding 命名 understandable as a simple book diagram
main_symbols: A naming-origin culture map: a loose community phrase spreads from casual coding sessions into shared practice cards and glossary adoption.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for H-63 Vibe Coding 命名.

Subject: The entry subject is Vibe Coding 命名, but the visual subject is A naming-origin culture map: a loose community phrase spreads from casual coding sessions into shared practice cards and glossary adoption.. Show Show blank conversation cards, coding practice blocks, and a neutral timeline of adoption; no product logos, no readable phrase text, no social UI. only as supporting elements.
