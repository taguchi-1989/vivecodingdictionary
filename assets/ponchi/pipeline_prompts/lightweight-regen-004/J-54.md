# J-54 ISO/IEC 42001 ponchi prompt
...
scene_goal: make ISO/IEC 42001 understandable as a simple book diagram
main_symbols: An AI management-system compliance loop: risk assessment, governance controls, monitoring, and improvement cards cycle around an organization model.
...
Subject: The entry subject is ISO/IEC 42001, but the visual subject is An AI management-system compliance loop: risk assessment, governance controls, monitoring, and improvement cards cycle around an organization model.. Show Use audit checklist blocks and control gates; no ISO logo, no certification seal, no readable standard number. only as supporting elements.
