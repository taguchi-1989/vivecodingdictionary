...
scene_goal: make 体験区分の凡例 understandable as a simple book diagram
main_symbols: An experience-category legend: several journey lanes show learning, building, comparing, and operating experiences as distinct colored card groups.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for A-4 体験区分の凡例.

Subject: The entry subject is 体験区分の凡例, but the visual subject is An experience-category legend: several journey lanes show learning, building, comparing, and operating experiences as distinct colored card groups.. Show Use abstract icons, swatches, and lane dividers without text; no service logos, no app UI. only as supporting elements.
...
Characters: female=use, male=omit, robot=omit. Use the recurring Character A/B/C visual references whenever those characters appear. Temporary people allowed=no; if used, keep them secondary and smaller than the recurring characters.
