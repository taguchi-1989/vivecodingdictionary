...
scene_goal: make VLM understandable as a simple book diagram
main_symbols: A vision-language model flow: image tiles and language tiles enter one shared model core, then produce grounded answer and caption cards.
...
Subject: The entry subject is VLM, but the visual subject is A vision-language model flow: image tiles and language tiles enter one shared model core, then produce grounded answer and caption cards.. Show Show camera-like image panels, blank token tiles, and cross-modal arrows; no product UI, no readable captions, no logos. only as supporting elements.
