...
scene_goal: make 更新履歴と更新方針 understandable as a simple book diagram
main_symbols: An update-history policy flow: change requests move through review, version snapshot, publication, and archive cards.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for A-10 更新履歴と更新方針.

Subject: The entry subject is 更新履歴と更新方針, but the visual subject is An update-history policy flow: change requests move through review, version snapshot, publication, and archive cards.. Show Show a neutral timeline and maintenance loop; no readable changelog text, no dates, no product UI. only as supporting elements.
