...
scene_goal: make GUI understandable as a simple book diagram
main_symbols: A graphical user interface concept: windows, buttons, sliders, and pointer actions organize commands visually for a user.
...
Subject: The entry subject is GUI, but the visual subject is A graphical user interface concept: windows, buttons, sliders, and pointer actions organize commands visually for a user.. Show Use generic interface blocks only; no real OS chrome, no app icons, no readable labels. only as supporting elements.
