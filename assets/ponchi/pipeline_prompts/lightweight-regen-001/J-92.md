...
scene_goal: make Linux understandable as a simple book diagram
main_symbols: An open operating-system architecture map: kernel-like core coordinates userspace apps, drivers, filesystems, and network services.
...
Subject: The entry subject is Linux, but the visual subject is An open operating-system architecture map: kernel-like core coordinates userspace apps, drivers, filesystems, and network services.. Show Use neutral OS layers and hardware interface blocks; no Linux penguin, no distro logos, no readable command text. only as supporting elements.
