...
scene_goal: make 識字（リテラシー） understandable as a simple book diagram
main_symbols: A literacy decision map: a reader turns unknown technical terms into practical understanding through context, examples, verification, and application cards.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for J-100 識字（リテラシー）.

Subject: The entry subject is 識字（リテラシー）, but the visual subject is A literacy decision map: a reader turns unknown technical terms into practical understanding through context, examples, verification, and application cards.. Show Show learning steps, glossary cards, and confidence loop; no readable words, no book-cover text, no product logos. only as supporting elements.
