...
clearspace:
  required: yes
  location: rightmost 40% of top 25% kept completely blank for official Claude logo
...
scene_goal: make Claude understandable as a simple book diagram
main_symbols: A long-context assistant service base scene: documents and reasoning cards flow into a neutral assistant workspace, leaving a clean blank logo area in the upper right.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for B-2 Claude.

Subject: The entry subject is Claude, but the visual subject is A long-context assistant service base scene: documents and reasoning cards flow into a neutral assistant workspace, leaving a clean blank logo area in the upper right.. Show Use calm abstract document and safety panels; no Claude logo, no Anthropic mark, no chat UI, no readable text. only as supporting elements.
