# G-47 Auto-compact ponchi prompt
...
scene_goal: make Auto-compact understandable as a simple book diagram
main_symbols: An auto-compaction comparison: an overflowing long conversation stack compresses into a compact summary block that lets the work continue.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for G-47 Auto-compact.

Subject: The entry subject is Auto-compact, but the visual subject is An auto-compaction comparison: an overflowing long conversation stack compresses into a compact summary block that lets the work continue.. Show A user watches context usage shrink while the next task arrow remains connected; no chat UI, no readable transcript, no product logos. only as supporting elements.
