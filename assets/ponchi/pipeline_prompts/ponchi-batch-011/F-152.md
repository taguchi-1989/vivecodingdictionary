...
scene_goal: make GPL understandable as a simple book diagram
main_symbols: A copyleft flow: original source package connects to modified source, redistribution package, and share-the-source obligation gate.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for F-152 GPL.

Subject: The entry subject is GPL, but the visual subject is A copyleft flow: original source package connects to modified source, redistribution package, and share-the-source obligation gate.. Show A developer checks how derivative distribution affects source release requirements; no GNU, FSF, animal marks, or readable license text. only as supporting elements.
