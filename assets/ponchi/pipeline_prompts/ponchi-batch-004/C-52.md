# C-52 Demis Hassabis ponchi prompt
...
scene_goal: make Demis Hassabis understandable as a simple book diagram
main_symbols: A research-to-product achievement map: scientific discovery blocks, game-solving milestone, lab leadership, and AI model platform path connect around an abstract researcher silhouette.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for C-52 Demis Hassabis.

Subject: The entry subject is Demis Hassabis, but the visual subject is A research-to-product achievement map: scientific discovery blocks, game-solving milestone, lab leadership, and AI model platform path connect around an abstract researcher silhouette.. Show Generic lab workers and blank science cards; no real-person likeness, official logos, named achievements, or readable text. only as supporting elements.
