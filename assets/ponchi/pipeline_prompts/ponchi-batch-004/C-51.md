# C-51 Dario Amodei ponchi prompt
...
scene_goal: make Dario Amodei understandable as a simple book diagram
main_symbols: A safety-focused AI company leadership map: research paper stack, model product block, safety review gate, and company growth path connect around an abstract leader silhouette.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for C-51 Dario Amodei.

Subject: The entry subject is Dario Amodei, but the visual subject is A safety-focused AI company leadership map: research paper stack, model product block, safety review gate, and company growth path connect around an abstract leader silhouette.. Show Generic researchers and reviewers around blank documents; no real-person likeness, official logos, or readable text. only as supporting elements.
