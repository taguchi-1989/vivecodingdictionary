# C-59 Jensen Huang ponchi prompt
...
scene_goal: make Jensen Huang understandable as a simple book diagram
main_symbols: A GPU-to-AI platform leadership map: graphics processors, data center racks, developer software, and AI model demand connect around an abstract CEO silhouette.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for C-59 Jensen Huang.

Subject: The entry subject is Jensen Huang, but the visual subject is A GPU-to-AI platform leadership map: graphics processors, data center racks, developer software, and AI model demand connect around an abstract CEO silhouette.. Show A technical buyer looking at blank hardware demand charts; no real-person likeness, official logos, chip model names, or readable text. only as supporting elements.
