# C-55 Mira Murati ponchi prompt
...
scene_goal: make Mira Murati understandable as a simple book diagram
main_symbols: A product leader map: model research, product launch, multimodal demo, and independent lab path connect around an abstract product-builder silhouette.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for C-55 Mira Murati.

Subject: The entry subject is Mira Murati, but the visual subject is A product leader map: model research, product launch, multimodal demo, and independent lab path connect around an abstract product-builder silhouette.. Show Generic product team members reviewing blank launch cards; no real-person likeness, official logos, product UI, or readable text. only as supporting elements.
