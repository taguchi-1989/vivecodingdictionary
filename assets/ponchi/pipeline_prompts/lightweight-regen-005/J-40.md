...
scene_goal: make IoT understandable as a simple book diagram
main_symbols: An internet-of-things network: small sensors, devices, and edge boxes send telemetry through a gateway into a neutral operations dashboard.
...
Subject: The entry subject is IoT, but the visual subject is An internet-of-things network: small sensors, devices, and edge boxes send telemetry through a gateway into a neutral operations dashboard.. Show Use home, factory, and field device silhouettes as generic icons; no product logos, no brand colors, no readable dashboard text. only as supporting elements.
