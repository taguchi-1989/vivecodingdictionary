# J-11 Deep Learning ponchi prompt
...
scene_goal: make Deep Learning understandable as a simple book diagram
main_symbols: A deep-learning layer stack: input patterns move through multiple hidden layers, each transforming features into richer abstract representations.
...
Subject: The entry subject is Deep Learning, but the visual subject is A deep-learning layer stack: input patterns move through multiple hidden layers, each transforming features into richer abstract representations.. Show Show layered nodes, feature maps, and output cards; no framework logos, no code, no readable layer names. only as supporting elements.
