...
scene_goal: make HDD understandable as a simple book diagram
main_symbols: A hard-disk storage diagram: spinning platter rings, actuator arm, cache buffer, and file blocks show mechanical storage access.
...
Subject: The entry subject is HDD, but the visual subject is A hard-disk storage diagram: spinning platter rings, actuator arm, cache buffer, and file blocks show mechanical storage access.. Show Use generic drive internals and data flow arrows; no manufacturer logo, no readable capacity text, no product label. only as supporting elements.
