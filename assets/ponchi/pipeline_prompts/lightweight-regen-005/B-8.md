...
subject_stack:
  ...
  logo_subject: official Codex brand overlay after source review
...
clearspace:
  required: yes
  location: rightmost 40% of top 25% kept completely blank for official Codex logo
...
scene_goal: make Codex understandable as a simple book diagram
main_symbols: A code-generation agent base scene: project files, task plan, patch cards, and test results flow through a neutral coding agent board, leaving a clean blank logo area in the upper right.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for B-8 Codex.

Subject: The entry subject is Codex, but the visual subject is A code-generation agent base scene: project files, task plan, patch cards, and test results flow through a neutral coding agent board, leaving a clean blank logo area in the upper right.. Show Use generic coding blocks and verification cards; no Codex or OpenAI logo, no readable code, no product UI. only as supporting elements.
