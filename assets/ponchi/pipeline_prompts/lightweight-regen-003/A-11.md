...
scene_goal: make 略称表記 understandable as a simple book diagram
main_symbols: An abbreviation-reference map: short code-like chips connect to expanded concept cards and usage examples without showing readable text.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for A-11 略称表記.

Subject: The entry subject is 略称表記, but the visual subject is An abbreviation-reference map: short code-like chips connect to expanded concept cards and usage examples without showing readable text.. Show Use paired small and large blank cards, glossary links, and lookup arrows; no actual abbreviations, no logos. only as supporting elements.
