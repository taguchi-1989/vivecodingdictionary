# I-20 Playwright MCP ponchi prompt
...
scene_goal: make Playwright MCP understandable as a simple book diagram
main_symbols: A browser-automation connector: a test request becomes page navigation, click, form, screenshot, and assertion cards across a generic browser panel.
...
Subject: The entry subject is Playwright MCP, but the visual subject is A browser-automation connector: a test request becomes page navigation, click, form, screenshot, and assertion cards across a generic browser panel.. Show A developer inspects automated browser steps; no Playwright logo, no real website UI, no readable test text. only as supporting elements.
