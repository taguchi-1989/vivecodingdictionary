...
scene_goal: make 図鑑の歩き方 understandable as a simple book diagram
main_symbols: A field-guide walking route: entries are arranged like exhibits along a path, with cross-reference arrows and discovery markers.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for A-3 図鑑の歩き方.

Subject: The entry subject is 図鑑の歩き方, but the visual subject is A field-guide walking route: entries are arranged like exhibits along a path, with cross-reference arrows and discovery markers.. Show Use a museum-map or atlas metaphor with blank cards; no readable index text, no brand marks. only as supporting elements.
