...
scene_goal: make Notion MCP understandable as a simple book diagram
main_symbols: A workspace-document connector: a client routes page search, page read, database query, and comment cards through a server into a generic document workspace.
...
Subject: The entry subject is Notion MCP, but the visual subject is A workspace-document connector: a client routes page search, page read, database query, and comment cards through a server into a generic document workspace.. Show Use blank page cards, database grids, and comment bubbles; no Notion logo, no real workspace UI, no readable page text. only as supporting elements.
