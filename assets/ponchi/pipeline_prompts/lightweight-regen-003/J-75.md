...
scene_goal: make Tensor コア understandable as a simple book diagram
main_symbols: A tensor-processing core diagram: matrix tiles enter specialized parallel compute blocks and return accelerated model-operation result cards.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for J-75 Tensor コア.

Subject: The entry subject is Tensor コア, but the visual subject is A tensor-processing core diagram: matrix tiles enter specialized parallel compute blocks and return accelerated model-operation result cards.. Show Show grid multiplication as abstract colored blocks, not formulas; no vendor logos, no readable math, no chip branding. only as supporting elements.
