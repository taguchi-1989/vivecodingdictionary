# J-31 第 5 世代コンピュータ ponchi prompt
...
scene_goal: make 第 5 世代コンピュータ understandable as a simple book diagram
main_symbols: A historical AI-computer initiative map: symbolic reasoning cards, specialized hardware blocks, and national research program nodes connect into a period-specific roadmap.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for J-31 第 5 世代コンピュータ.

Subject: The entry subject is 第 5 世代コンピュータ, but the visual subject is A historical AI-computer initiative map: symbolic reasoning cards, specialized hardware blocks, and national research program nodes connect into a period-specific roadmap.. Show Show archival-style planning boards and machine blocks without readable dates or country marks; no official emblems, no product logos. only as supporting elements.
