...
main_symbols: A color-and-symbol legend: swatches, arrows, warning markers, check markers, and neutral nodes explain how to read diagrams.
...
Subject: The entry subject is 色・記号の凡例, but the visual subject is A color-and-symbol legend: swatches, arrows, warning markers, check markers, and neutral nodes explain how to read diagrams.. Show Show symbols as abstract shapes only; no text labels, no official icons, no brand palette. only as supporting elements.
