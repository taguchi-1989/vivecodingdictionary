# H-62 Anthropic 創業の流れ ponchi prompt
...
scene_goal: make Anthropic 創業の流れ understandable as a simple book diagram
main_symbols: An AI-company founding flow: researchers leave a large neutral lab context, gather around a safety-focused startup table, and build a new model research path.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for H-62 Anthropic 創業の流れ.

Subject: The entry subject is Anthropic 創業の流れ, but the visual subject is An AI-company founding flow: researchers leave a large neutral lab context, gather around a safety-focused startup table, and build a new model research path.. Show Use abstract organization buildings, research paper cards, safety shield, and founding team silhouettes; no Anthropic or Claude logo, no real-person likenesses. only as supporting elements.
