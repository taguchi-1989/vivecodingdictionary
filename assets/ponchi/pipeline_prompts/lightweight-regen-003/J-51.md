# J-51 Hallucination ponchi prompt
...
scene_goal: make Hallucination understandable as a simple book diagram
main_symbols: A hallucination detection flow: a confident-looking answer card is checked against source cards, with unsupported parts routed to review and correction.
...
Subject: The entry subject is Hallucination, but the visual subject is A hallucination detection flow: a confident-looking answer card is checked against source cards, with unsupported parts routed to review and correction.. Show Show verification magnifier, evidence links, and warning markers; no chat UI, no readable claims, no product logos. only as supporting elements.
