...
scene_goal: make 個人情報保護法 understandable as a simple book diagram
main_symbols: A personal-information protection flow: user data cards pass through consent, purpose, minimization, storage, and deletion gates.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for J-55 個人情報保護法.

Subject: The entry subject is 個人情報保護法, but the visual subject is A personal-information protection flow: user data cards pass through consent, purpose, minimization, storage, and deletion gates.. Show Show privacy shields, access locks, and lifecycle arrows; no government emblem, no legal text, no readable identifiers. only as supporting elements.
