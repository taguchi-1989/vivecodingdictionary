...
scene_goal: make 読者レベルの凡例 understandable as a simple book diagram
main_symbols: A reader-level ladder: beginner, practitioner, and advanced reading paths climb through increasingly detailed concept cards.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for A-5 読者レベルの凡例.

Subject: The entry subject is 読者レベルの凡例, but the visual subject is A reader-level ladder: beginner, practitioner, and advanced reading paths climb through increasingly detailed concept cards.. Show Show level tiers, confidence gauges, and route choices as blank graphics; no readable labels, no badges. only as supporting elements.
