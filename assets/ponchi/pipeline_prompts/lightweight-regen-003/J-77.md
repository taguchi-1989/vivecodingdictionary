...
scene_goal: make GPU (概念) understandable as a simple book diagram
main_symbols: A graphics-processing concept diagram: many parallel shader-like lanes transform geometry, pixels, and AI workload tiles into visual result cards.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for J-77 GPU (概念).

Subject: The entry subject is GPU (概念), but the visual subject is A graphics-processing concept diagram: many parallel shader-like lanes transform geometry, pixels, and AI workload tiles into visual result cards.. Show Show generic graphics hardware and parallel compute blocks; no vendor logos, no product badges, no readable model names. only as supporting elements.
