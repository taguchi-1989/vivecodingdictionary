...
clearspace:
  required: yes
  location: rightmost 40% of top 25% kept completely blank for official Ghostty logo
...
scene_goal: make Ghostty understandable as a simple book diagram
main_symbols: A modern terminal workspace workflow: terminal window blocks, tabs, split panes, shell session cards, and keyboard-driven navigation connect together.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for F-84 Ghostty.

Subject: The entry subject is Ghostty, but the visual subject is A modern terminal workspace workflow: terminal window blocks, tabs, split panes, shell session cards, and keyboard-driven navigation connect together.. Show A developer uses a generic terminal emulator; no Ghostty logo, ghost icon, product UI, or readable shell text. only as supporting elements.
