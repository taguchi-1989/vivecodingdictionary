# E-51 LMSYS Arena ponchi prompt
...
scene_goal: make LMSYS Arena understandable as a simple book diagram
main_symbols: A community model-rating arena: many anonymous model cards enter pairwise comparisons, user preference votes flow into a ranking chart.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for E-51 LMSYS Arena.

Subject: The entry subject is LMSYS Arena, but the visual subject is A community model-rating arena: many anonymous model cards enter pairwise comparisons, user preference votes flow into a ranking chart.. Show A reviewer studies generic ranking movement and uncertainty bars; no organization logos, product UI, readable text, or red/green marks. only as supporting elements.
