...
scene_goal: make OSWorld understandable as a simple book diagram
main_symbols: An operating-system task benchmark workflow: desktop-like generic panels, file operations, settings cards, and completion score connect along an agent path.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for E-34 OSWorld.

Subject: The entry subject is OSWorld, but the visual subject is An operating-system task benchmark workflow: desktop-like generic panels, file operations, settings cards, and completion score connect along an agent path.. Show A reviewer watches an agent manipulate neutral OS panels; no real OS icons, app logos, readable text, or red/green marks. only as supporting elements.
