...
scene_goal: make IQ Bench understandable as a simple book diagram
main_symbols: An intelligence-test benchmark map: pattern puzzles, sequence cards, spatial reasoning tiles, and answer-choice evaluation connect around a model block.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for E-27 IQ Bench.

Subject: The entry subject is IQ Bench, but the visual subject is An intelligence-test benchmark map: pattern puzzles, sequence cards, spatial reasoning tiles, and answer-choice evaluation connect around a model block.. Show A reviewer comparing abstract puzzle cards; no official logos, readable text, product UI, or red/green marks. only as supporting elements.
