...
scene_goal: make WebArena understandable as a simple book diagram
main_symbols: A web-task benchmark workflow: generic browser window, form-like panels, navigation choices, and completion scoring connect as an agent path.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for E-31 WebArena.

Subject: The entry subject is WebArena, but the visual subject is A web-task benchmark workflow: generic browser window, form-like panels, navigation choices, and completion scoring connect as an agent path.. Show A reviewer tracks an agent through blank web pages; no real website UI, browser logos, product logos, readable text, or red/green marks. only as supporting elements.
