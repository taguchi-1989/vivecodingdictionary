...
scene_goal: make AIME understandable as a simple book diagram
main_symbols: A contest math benchmark diagram: timed problem set, reasoning workspace, answer selection, and ranked score chart connect in a clean flow.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for E-25 AIME.

Subject: The entry subject is AIME, but the visual subject is A contest math benchmark diagram: timed problem set, reasoning workspace, answer selection, and ranked score chart connect in a clean flow.. Show A reviewer monitoring generic competition-style math cards; no official logos, readable formulas, medals with text, or red/green marks. only as supporting elements.
