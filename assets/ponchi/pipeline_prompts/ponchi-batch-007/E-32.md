...
scene_goal: make GAIA understandable as a simple book diagram
main_symbols: A general assistant benchmark workflow: file cards, web snippets, reasoning notes, and final answer evaluation combine into a multi-step task path.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for E-32 GAIA.

Subject: The entry subject is GAIA, but the visual subject is A general assistant benchmark workflow: file cards, web snippets, reasoning notes, and final answer evaluation combine into a multi-step task path.. Show A reviewer assembling evidence from generic sources; no official logos, real websites, product UI, readable text, or red/green marks. only as supporting elements.
