...
scene_goal: make GPQA understandable as a simple book diagram
main_symbols: A graduate-level science question benchmark: expert question cards feed a reasoning model block, then evidence checks and answer scoring cards appear.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for E-22 GPQA.

Subject: The entry subject is GPQA, but the visual subject is A graduate-level science question benchmark: expert question cards feed a reasoning model block, then evidence checks and answer scoring cards appear.. Show A reviewer with generic science symbols and blank answer cards; no institution logos, product UI, readable text, or red/green marks. only as supporting elements.
