...
scene_goal: make MATH understandable as a simple book diagram
main_symbols: A challenging math benchmark workflow: theorem-like problem cards feed scratchpad reasoning, symbolic transformation tiles, and a neutral scoring panel.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for E-24 MATH.

Subject: The entry subject is MATH, but the visual subject is A challenging math benchmark workflow: theorem-like problem cards feed scratchpad reasoning, symbolic transformation tiles, and a neutral scoring panel.. Show A reviewer comparing solution paths on blank math cards; no official logos, readable formulas, product UI, or red/green marks. only as supporting elements.
