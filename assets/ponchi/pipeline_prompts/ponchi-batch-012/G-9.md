...
scene_goal: make effort レベル understandable as a simple book diagram
main_symbols: A reasoning effort control panel: low, medium, and high effort lanes expand from quick answer cards to deeper planning and verification cards.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for G-9 effort レベル.

Subject: The entry subject is effort レベル, but the visual subject is A reasoning effort control panel: low, medium, and high effort lanes expand from quick answer cards to deeper planning and verification cards.. Show A user chooses how much invisible work the assistant spends before responding; no model/provider logos, no readable labels, no chat UI. only as supporting elements.
