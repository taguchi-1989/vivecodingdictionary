# G-11 Context Engineering ponchi prompt
...
subject_stack:
  entry_subject: Context Engineering
...
scene_goal: make Context Engineering understandable as a simple book diagram
main_symbols: A context engineering workflow: goal card, background notes, retrieved facts, tool outputs, and memory cards assemble into one organized context pack.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for G-11 Context Engineering.

Subject: The entry subject is Context Engineering, but the visual subject is A context engineering workflow: goal card, background notes, retrieved facts, tool outputs, and memory cards assemble into one organized context pack.. Show A developer selects relevant blank materials before sending them to an assistant; no model/provider logos, no readable text, no chat UI. only as supporting elements.
