# G-14 Thinking モデル ponchi prompt
...
scene_goal: make Thinking モデル understandable as a simple book diagram
main_symbols: A thinking model workspace: hidden scratch area, planning cards, verification loop, and final answer panel are separated by a privacy boundary.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for G-14 Thinking モデル.

Subject: The entry subject is Thinking モデル, but the visual subject is A thinking model workspace: hidden scratch area, planning cards, verification loop, and final answer panel are separated by a privacy boundary.. Show A user receives a concise result while abstract internal work happens behind a translucent boundary; no model/provider logos, no readable text. only as supporting elements.
