...
clearspace:
  required: yes
  location: rightmost 40% of top 25% kept completely blank for official Flow logo
...
scene_goal: make Flow understandable as a simple book diagram
main_symbols: A creative image/video tool workflow: concept board, prompt, and reference assets flow into a generation canvas, then variants and review cards appear.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for D-57 Flow.

Subject: The entry subject is Flow, but the visual subject is A creative image/video tool workflow: concept board, prompt, and reference assets flow into a generation canvas, then variants and review cards appear.. Show A designer comparing generic creative outputs; no Flow logo, product UI, or readable text. only as supporting elements.
