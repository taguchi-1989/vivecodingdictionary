...
main_symbols: A welcoming map for a technical picture dictionary: a reader opens a guidebook and sees broad paths through tools, concepts, and practice cards.
...
Subject: The entry subject is まえがき, but the visual subject is A welcoming map for a technical picture dictionary: a reader opens a guidebook and sees broad paths through tools, concepts, and practice cards.. Show Use blank chapter cards, route arrows, and a calm reading desk; no book title text, no logos, no readable labels. only as supporting elements.
...
Characters: female=use, male=omit, robot=omit. Use the recurring Character A/B/C visual references whenever those characters appear. Temporary people allowed=yes; if used, keep them secondary and smaller than the recurring characters.
