...
scene_goal: make VRAM understandable as a simple book diagram
main_symbols: A graphics-memory capacity diagram: model layers and image batches load into dedicated memory chips, with overflow pressure shown as blocked cards.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for J-70 VRAM.

Subject: The entry subject is VRAM, but the visual subject is A graphics-memory capacity diagram: model layers and image batches load into dedicated memory chips, with overflow pressure shown as blocked cards.. Show Show memory banks, bandwidth arrows, and workload tiles; no chip vendor logos, no readable capacity numbers. only as supporting elements.
