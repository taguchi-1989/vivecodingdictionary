...
scene_goal: make AI 倫理 understandable as a simple book diagram
main_symbols: An AI ethics review board: model output cards pass through fairness, safety, privacy, and accountability checkpoints before release.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for J-50 AI 倫理.

Subject: The entry subject is AI 倫理, but the visual subject is An AI ethics review board: model output cards pass through fairness, safety, privacy, and accountability checkpoints before release.. Show Show diverse stakeholder silhouettes, risk cards, and approval gates; no official seals, no readable policy text. only as supporting elements.
...
Characters: female=omit, male=omit, robot=use. Use the recurring Character A/B/C visual references whenever those characters appear. Temporary people allowed=no; if used, keep them secondary and smaller than the recurring characters.
