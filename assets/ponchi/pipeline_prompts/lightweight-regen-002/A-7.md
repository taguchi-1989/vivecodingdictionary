...
scene_goal: make 図のタイプ understandable as a simple book diagram
main_symbols: A figure-type legend: comparison, workflow, architecture, timeline, and decision-map panels are arranged as a visual taxonomy.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for A-7 図のタイプ.

Subject: The entry subject is 図のタイプ, but the visual subject is A figure-type legend: comparison, workflow, architecture, timeline, and decision-map panels are arranged as a visual taxonomy.. Show Use miniature blank diagram thumbnails and category grouping; no readable labels, no logos. only as supporting elements.
