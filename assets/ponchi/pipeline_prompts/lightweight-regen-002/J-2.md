...
scene_goal: make 強い AI／弱い AI understandable as a simple book diagram
main_symbols: A comparison between narrow task AI and broad flexible AI: one side solves a single bounded task, while the other adapts across several abstract domains.
...
Primary request: Create a 2:1 horizontal technical-book ponchi illustration for J-2 強い AI／弱い AI.

Subject: The entry subject is 強い AI／弱い AI, but the visual subject is A comparison between narrow task AI and broad flexible AI: one side solves a single bounded task, while the other adapts across several abstract domains.. Show Use two contrasting panels with task cards, transfer arrows, and capability gauges; no readable text, no product names, no brand colors. only as supporting elements.
