...
scene_goal: make GDPR understandable as a simple book diagram
main_symbols: A data-protection compliance workflow: personal data moves through lawful basis, rights request, transfer, and audit-control checkpoints.
...
Subject: The entry subject is GDPR, but the visual subject is A data-protection compliance workflow: personal data moves through lawful basis, rights request, transfer, and audit-control checkpoints.. Show Use neutral regulatory map cards and privacy gates; no EU flag, no official logo, no readable article numbers. only as supporting elements.
