...
- Wave 004 base generation is 20/60.
- Total numerically tracked generated bases are now 160/350.

## Next best actions

1. Continue Wave 004 / Batch 011:
   - Inspect `ledgers/ponchi_generation_batches.csv` for `ponchi-batch-011`.
...
2. Generate and audit Batch 011:
   ...
   - Run `python scripts\ponchi_batch_audit.py ponchi-batch-011`.
   - Run `python scripts\ponchi_batch_report.py ponchi-batch-011`.
