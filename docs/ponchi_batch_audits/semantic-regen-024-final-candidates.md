# semantic-regen-024 final candidates

These files are staged review candidates. They do not overwrite `assets/ponchi/final/`.

## Contact Sheet

`assets/ponchi/final_candidates/semantic-regen-024/final_candidates_contact_sheet.png`

## Candidates

| entry | title | source | candidate png | candidate webp | status |
| --- | --- | --- | --- | --- | --- |
| `J-90` | GUI | `review_pending_base` | `J-90_candidate.png` | `J-90_candidate.webp` | `review_pending` |
| `J-92` | Linux | `review_pending_base` | `J-92_candidate.png` | `J-92_candidate.webp` | `review_pending` |
| `J-93` | Ubuntu | `review_pending_base` | `J-93_candidate.png` | `J-93_candidate.webp` | `review_pending` |
