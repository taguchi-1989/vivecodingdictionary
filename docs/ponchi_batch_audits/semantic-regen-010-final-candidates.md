# semantic-regen-010 final candidates

These files are staged review candidates. They do not overwrite `assets/ponchi/final/`.

## Contact Sheet

`assets/ponchi/final_candidates/semantic-regen-010/final_candidates_contact_sheet.png`

## Candidates

| entry | title | source | candidate png | candidate webp | status |
| --- | --- | --- | --- | --- | --- |
| `I-20` | Playwright MCP | `review_pending_base` | `I-20_candidate.png` | `I-20_candidate.webp` | `review_pending` |
| `I-21` | Puppeteer MCP | `review_pending_base` | `I-21_candidate.png` | `I-21_candidate.webp` | `review_pending` |
| `I-22` | Chrome DevTools MCP | `review_pending_base` | `I-22_candidate.png` | `I-22_candidate.webp` | `review_pending` |
