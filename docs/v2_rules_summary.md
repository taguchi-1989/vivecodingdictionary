...
**著者記入欄の文字数方針（2026-05-02 改）**: 旧目安（私のコメント 20〜35 字／つまずき 15〜30 字）に対して、実際の執筆物では 1 行 40〜55 字に自然と落ち着く実態があった。誌面枠を保つために**上限のみ**を設けて、上限内なら自由に書ける運用にする。上限超は ⚠️ 警告。

| 箇所 | 項目数 | 項目あたり | 総文字数目安 | 判定 |
|---|---|---|---|---|
| **非エンジニアのつまずき**（著者記入） | **3 項目固定** | 推奨 30〜50／許容 〜60 字 | 90〜180 | ⚠️（項目数 ＋ 60 字超） |
| **私のコメント**（著者記入） | **4 項目固定**（first/good/bad/who） | 推奨 25〜40／許容 〜45 字 | 100〜180 | ⚠️（項目数 ＋ 45 字超） |
...
```
- 🙂 第一印象: （推奨 25〜40／上限 45 字）
- 👍 良い点:   （推奨 25〜40／上限 45 字）
- 👎 ダメな点: （推奨 25〜40／上限 45 字）
- 👥 誰向けか: （推奨 25〜40／上限 45 字）
```
