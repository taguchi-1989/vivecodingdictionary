...
この余白は、2:1 の画像を後から壊さずにロゴを入れるための設計領域として扱う。ベース画像の段階で、ロゴ予定領域の下に人物、顔、手、重要ノード、矢印、主図解、模様、薄いアイコンを置かない。画面全体は完成した 2:1 の誌面に見せるが、右上 clearspace は静かな negative space として残す。
