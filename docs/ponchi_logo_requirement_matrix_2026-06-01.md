...
| :-- | :-- | :-- | :-- | :-- | :-- |
| `B-1` | Gemini | required | `base_2to1_ready_logo_blocked` | none | 2:1 ベース生成済み。Gemini 公式素材と利用条件を確認するまで本番ロゴ合成は停止 |
| `B-2` | Claude | required | `base_2to1_ready_logo_blocked` | none | 2:1 ベース生成済み。Claude 公式素材と利用条件を確認するまで本番ロゴ合成は停止 |
| `B-3` | ChatGPT | required | `base_2to1_ready_logo_blocked` | none | 2:1 ベース生成済み。OpenAI / ChatGPT 公式素材と利用条件を確認するまで本番ロゴ合成は停止 |
| `B-4` | Cursor | required | `base_2to1_ready_logo_blocked` | none | 2:1 ベース生成済み。Cursor 公式素材と利用条件を確認するまで本番ロゴ合成は停止 |
...
| `B-8` | Codex | required | `base_2to1_ready_logo_blocked` | none | 2:1 ベース生成済み。OpenAI / Codex 公式素材と利用条件を確認するまで本番ロゴ合成は停止 |
...
3. `base_2to1_ready_logo_blocked` は公式素材の取得・利用条件確認ができるまで、本番ロゴ合成と本番差し替えを進めない。
