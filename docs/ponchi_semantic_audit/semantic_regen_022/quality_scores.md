...
- CSV: `ledgers/semantic_regen_022_quality_scores.csv`
- Low score contact sheet: `docs/ponchi_semantic_audit/semantic_regen_022/quality_low_contact_sheet.png`
- Mid review contact sheet: `docs/ponchi_semantic_audit/semantic_regen_022/quality_mid_contact_sheet.png`
- Known padding contact sheet: `docs/ponchi_semantic_audit/semantic_regen_022/quality_known_contact_sheet.png`
- Sparse diagram contact sheet: `docs/ponchi_semantic_audit/semantic_regen_022/quality_sparse_contact_sheet.png`
...
| --- | --- | ---: | --- | --- |
| `J-31_base_1254x627` |  | 87 | `light_review` | `` |
| `J-40_base_1254x627` |  | 90 | `light_review` | `` |
| `J-42_base_1254x627` |  | 92 | `light_review` | `` |
| `J-43_base_1254x627` |  | 94 | `light_review` | `` |
| `J-33_base_1254x627` |  | 95 | `light_review` | `` |
| `J-100_base_1254x627` |  | 96 | `light_review` | `` |
| `J-41_base_1254x627` |  | 96 | `light_review` | `` |
| `J-32_base_1254x627` |  | 99 | `light_review` | `` |
