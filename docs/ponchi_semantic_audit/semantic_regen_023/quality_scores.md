...
- CSV: `ledgers/semantic_regen_023_quality_scores.csv`
- Low score contact sheet: `docs/ponchi_semantic_audit/semantic_regen_023/quality_low_contact_sheet.png`
- Mid review contact sheet: `docs/ponchi_semantic_audit/semantic_regen_023/quality_mid_contact_sheet.png`
- Known padding contact sheet: `docs/ponchi_semantic_audit/semantic_regen_023/quality_known_contact_sheet.png`
- Sparse diagram contact sheet: `docs/ponchi_semantic_audit/semantic_regen_023/quality_sparse_contact_sheet.png`
...
| --- | --- | ---: | --- | --- |
| `J-53_base_1254x627` |  | 91 | `light_review` | `` |
| `J-51_base_1254x627` |  | 92 | `light_review` | `` |
| `J-52_base_1254x627` |  | 94 | `light_review` | `` |
| `J-50_base_1254x627` |  | 96 | `light_review` | `` |
| `J-56_base_1254x627` |  | 96 | `light_review` | `` |
| `J-54_base_1254x627` |  | 97 | `light_review` | `` |
| `J-55_base_1254x627` |  | 99 | `light_review` | `` |
| `J-62_base_1254x627` |  | 99 | `light_review` | `` |
