...
- CSV: `ledgers/semantic_regen_019_quality_scores.csv`
- Low score contact sheet: `docs/ponchi_semantic_audit/semantic_regen_019/quality_low_contact_sheet.png`
- Mid review contact sheet: `docs/ponchi_semantic_audit/semantic_regen_019/quality_mid_contact_sheet.png`
- Known padding contact sheet: `docs/ponchi_semantic_audit/semantic_regen_019/quality_known_contact_sheet.png`
- Sparse diagram contact sheet: `docs/ponchi_semantic_audit/semantic_regen_019/quality_sparse_contact_sheet.png`
...
| --- | --- | ---: | --- | --- |
| `I-22_base_1254x627` |  | 96 | `light_review` | `` |
| `I-20_base_1254x627` |  | 98 | `light_review` | `` |
| `I-21_base_1254x627` |  | 100 | `light_review` | `` |
