...
- CSV: `ledgers/semantic_regen_017_quality_scores.csv`
- Low score contact sheet: `docs/ponchi_semantic_audit/semantic_regen_017/quality_low_contact_sheet.png`
- Mid review contact sheet: `docs/ponchi_semantic_audit/semantic_regen_017/quality_mid_contact_sheet.png`
- Known padding contact sheet: `docs/ponchi_semantic_audit/semantic_regen_017/quality_known_contact_sheet.png`
- Sparse diagram contact sheet: `docs/ponchi_semantic_audit/semantic_regen_017/quality_sparse_contact_sheet.png`
...
| --- | --- | ---: | --- | --- |
| `I-5_base_1254x627` |  | 93 | `light_review` | `` |
| `I-4_base_1254x627` |  | 95 | `light_review` | `` |
| `I-80_base_1254x627` |  | 96 | `light_review` | `` |
| `I-81_base_1254x627` |  | 96 | `light_review` | `` |
| `I-1_base_1254x627` |  | 97 | `light_review` | `` |
| `I-2_base_1254x627` |  | 97 | `light_review` | `` |
| `I-3_base_1254x627` |  | 97 | `light_review` | `` |
