...
- CSV: `ledgers/semantic_regen_020_quality_scores.csv`
- Low score contact sheet: `docs/ponchi_semantic_audit/semantic_regen_020/quality_low_contact_sheet.png`
- Mid review contact sheet: `docs/ponchi_semantic_audit/semantic_regen_020/quality_mid_contact_sheet.png`
- Known padding contact sheet: `docs/ponchi_semantic_audit/semantic_regen_020/quality_known_contact_sheet.png`
- Sparse diagram contact sheet: `docs/ponchi_semantic_audit/semantic_regen_020/quality_sparse_contact_sheet.png`
...
| --- | --- | ---: | --- | --- |
| `J-3_base_1254x627` |  | 83 | `visual_review` | `線密度` |
| `J-11_base_1254x627` |  | 91 | `light_review` | `` |
| `J-14_base_1254x627` |  | 92 | `light_review` | `` |
| `J-1_base_1254x627` |  | 92 | `light_review` | `線密度` |
| `J-12_base_1254x627` |  | 94 | `light_review` | `` |
| `J-15_base_1254x627` |  | 94 | `light_review` | `` |
| `J-13_base_1254x627` |  | 95 | `light_review` | `` |
| `J-2_base_1254x627` |  | 96 | `light_review` | `` |
| `J-10_base_1254x627` |  | 97 | `light_review` | `` |
| `J-4_base_1254x627` |  | 98 | `light_review` | `` |
