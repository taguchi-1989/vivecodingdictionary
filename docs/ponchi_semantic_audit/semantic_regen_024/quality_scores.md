...
- CSV: `ledgers/semantic_regen_024_quality_scores.csv`
- Low score contact sheet: `docs/ponchi_semantic_audit/semantic_regen_024/quality_low_contact_sheet.png`
- Mid review contact sheet: `docs/ponchi_semantic_audit/semantic_regen_024/quality_mid_contact_sheet.png`
- Known padding contact sheet: `docs/ponchi_semantic_audit/semantic_regen_024/quality_known_contact_sheet.png`
- Sparse diagram contact sheet: `docs/ponchi_semantic_audit/semantic_regen_024/quality_sparse_contact_sheet.png`
...
| --- | --- | ---: | --- | --- |
| `J-92_base_1254x627` |  | 88 | `light_review` | `` |
| `J-93_base_1254x627` |  | 93 | `light_review` | `` |
| `J-90_base_1254x627` |  | 97 | `light_review` | `` |
