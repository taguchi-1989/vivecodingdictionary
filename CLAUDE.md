...
- **左ページ**：tagline ／ 何をしてくれるか ／ どこで出会うか ／ メイン図 ／ 関連用語（**「ひとことで」は削除、「バイブコーディングでの位置づけ」は「どこで出会うか」にリネーム**）
...
2. [docs/book_philosophy.md](docs/book_philosophy.md) — 根っこのフィロソフィー
3. [docs/editorial_style.md](docs/editorial_style.md) — トーン・文体の原則
4. [templates/entry_template.md](templates/entry_template.md) — 構造の正解
5. [ledgers/entry_candidates.md](ledgers/entry_candidates.md) — 335 件の棚と要確認
6. [ledgers/writing_priority.md](ledgers/writing_priority.md) — ステージ別の執筆順
7. [docs/id_scheme.md](docs/id_scheme.md) — ID ルール（触らない）
