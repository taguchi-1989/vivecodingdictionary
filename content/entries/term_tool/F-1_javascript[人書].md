...
- JavaScript は聞いたことがある気もするが、得体が知れない。非エンジニアからすると Java と JavaScript が違うことも分かりづらいし、「JS」という拡張子のファイルは触れる気がしない。
- 中身も結構触りづらく、非エンジニアからするとハードルが高い。「○○ JS」とついているライブラリが多くて、何が何なのか分からない。
-
...
- 👥 誰向けか: 「知らないだけで、みんな実は使っているんだ」と意識したい人。まず色々やってみたい人。
