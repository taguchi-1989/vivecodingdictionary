...
- 自分でアプリを作れると思った瞬間の感動は大きかったのですが、Next.js との相性が悪く、片方を動かすともう片方が壊れるという状況に何度も陥りました。
- アプリの配布まわりも難しく、「できた風」にはなれても完成と言えるものを出すまでに苦労しました。

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: 自分でインストール可能なアプリが作れると気づいたときの感動は大きかったです。
- 👍 良い点: 持ち運びできるスタンドアロンの環境を作るという用途ではかなり良い選択だと思います。
- 👎 ダメな点: セキュリティが甘く、会社環境で使うには脆弱性リスクがあります。業務利用には向かず、遊び用の印象が強いです。
- 👥 誰向けか: 「インストールできるアプリを自分で作ってみたい」という感動を味わいたい人向けだと思います。個人の遊び・試作向けです。
