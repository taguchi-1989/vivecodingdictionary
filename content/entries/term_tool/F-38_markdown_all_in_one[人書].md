...
VS Code（F-30）に Markdown（F-6）の編集補助を追加します。Ctrl+B で太字、Enter で箇条書き継続、目次（TOC）の自動生成、テーブルの自動整形など、反復作業をまとめて引き受けます。
...
VS Code 上で Markdown の編集補助機能を一括提供する拡張です。

### 2. うれしさ

目次生成や箇条書き継続など反復作業が減り、書くリズムを保てます。

### 3. 注意点

プレビュー機能は最小限で、凝った表示には F-35 との併用が必要です。

### 4. どこで役立つか

README・設計書・図鑑エントリなど Markdown 量が多い編集作業に効きます。

### 5. はじめに

VS Code に入れて目次自動生成と Ctrl+B の動作を確かめると理解できます。
...
-自分でこう触ってく時のちょっとした効率化とかにはすごい繋がる印象があるよね。あとTF を作る機能もあって、それはいいんだけどあのラテフだとかマーメイドだとかってのを PDF 印刷をこれでしようとした時に大体負けかないってのでつっかえる。ここが大体ハードになるで嫌になるってとこだねで、なんか使えないやとかっていう。風にとか時間取られがち
-
-
...
- 🙂 第一印象:置く人が作ってくれるのま Word であるの機能があって便利やな
- 👍 良い点:ま人がちょこちょこ触る時のちょっとした効率書いた。繋がる
- 👎 ダメな点:まできないことがやっぱあったりとかするし、あのもっと楽な形ベルで出させるとか。もっと別の方法あるからなんか今中央ってあんま変わってないんだよね。あんま感じない
- 👥 誰向けか:パターンを YouTube で自分で自由に触りたい人、ネイティブで自由に触りたい
