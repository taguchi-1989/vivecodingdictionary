...
- PowerShell とコマンドプロンプトで微妙に違いがあり、片方しかできないことがあります。
- 管理者権限の扱いも異なり、同じ Windows でもターミナルによって挙動が変わります。
- 似た環境がいくつもあって言語も微妙に異なる点が非常にわかりにくいです。

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: コマンドプロンプトの上位互換だと思っていましたが、下位互換性があると知りました
- 👍 良い点: コマンドプロンプトよりリッチだと思います
- 👎 ダメな点: 互換しないところがあります
- 👥 誰向けか: 何かをインストールしたりツールを集めたり整理したりする人向けかなと思います
