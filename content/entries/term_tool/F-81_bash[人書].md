...
-Windows 環境だとさ、コマンドプロンプトのところにバッシュで書かれてる内容のやつをコピペしても動かないんだよね。で、バッシュってこの wsl とかのえっと Linux 環境で動いているコマンドっていうところを理解しないとか。まそもそもコマンドブロックとパワーセルとかっていう風なところもある。しってよく見るけど全く理解できなかったんだよね。そこに貼り付けければ良さそうだけど、そこでつまづいたな
-
-
...
- 🙂 第一印象:コマンドプロンプトっぽいけど違うみたい
- 👍 良い点:Linux ベースの操作ができるよね
- 👎 ダメな点:Windows ベースだとちょっと工夫が必要だよね。ひと手間
- 👥 誰向けか:これも L レムってエージェント的に使ってく人は結構ポイントかも
