...
- React を学んだところで「なぜ Next.js まで必要なのか」がなかなか腹落ちしませんでした。ただ AI がとにかく推してくるので、気づいたら使うことになっていた、という感じです。
- 複雑な実装をすると壊れやすく、特にバージョンアップ時の互換性まわりで手間がかかりました。使っているゆえに不満も感じやすいフレームワークです。

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: なぜ使わなければいけないか分からないまま、AI が猛烈に推してくるのでついていく形になりました。
- 👍 良い点: TypeScript 系でサイトを作るなら事実上の標準になりつつある点は認めます。
- 👎 ダメな点: 重い上に Vercel へのロックインが気になります。
- 👥 誰向けか: 自作アプリやサイトを作りたい人向けですが、ある程度の経験がないと扱いが難しいと感じます。
