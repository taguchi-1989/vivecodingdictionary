...
-パワーシェルとコマンドプロンプトで微妙にこう違ったりするのがあるんだよね。片っぽはできたり片っぽできなかったりとか、えっと管理者権限のところがどうかとかってとことか。同じ Windows 環境のところでも、あのターミナル系のとこでも微妙にこう言語を違ったりして、そこが非常に
-
-
...
- 🙂 第一印象:コマンドプロンプトの上位互換だと思ってた下位互換性があると思ってた
- 👍 良い点:リッチかな？コマンドプロンプとより
- 👎 ダメな点:共通しないんだよね。共通しないところ
- 👥 誰向けか:何らかのインストールしたりとかの道具を集めたりとか整理したりする人向けかな
