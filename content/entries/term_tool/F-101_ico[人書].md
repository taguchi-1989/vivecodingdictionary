...
Web サイトを作ると `favicon.ico` をルートに置くよう求められます。AI に「favicon を用意して」と頼むと `.ico` 生成を提案されます。Windows のショートカットアイコンにも使われます。
...
-
-画像生成で作ったものを、あのアイコンのところに設定しようと思うと、この拡張子変えるだけじゃダメでま特別な処理をかけないといけないって。ところで、これ知らなくてなっての1つ目、もう1個が何も設定しないとかになってしまって、毎回同じものが出てしまってあ なん か 全然
-
...
- 🙂 第一印象:あそこのWeb のところの上のところにあるの？ってピンクとか jpex ないんだっていうところやね。 ICO っていう風なファイルって知らんかった
- 👍 良い点:ま非常な軽量なものでま特徴を伝えられるというかていうので、何かを識別することができるよね。自分のサイト作った時に
- 👎 ダメな点:まあ Web 制作とかしないと、そもそもこの拡張子の名前すら知らんよね
- 👥 誰向けか:自分でサイト作ってそれデプロイする人かな？社内システムとかで作る人は何も設定してない？バニラのやつじゃなくて、さすがに設定してほしいよなとか思ったりするよね
