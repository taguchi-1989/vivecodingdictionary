...
- Electron の代替として AI に教えてもらって初めて知りました。当時は学習リソースが少なかったのか、AI がうまくコードを書いてくれないことがあり、Electron との比較表や概念の理解に時間がかかりました。（現在は状況が変わっているかもしれません。）
...
- 👎 ダメな点: 1年ほど前の話ですが、学習リソースが少なく、AI が高品質なコードをうまく出しにくい印象がありました。現在は改善されているかもしれません。
