...
- 1年ほど前に HTML でサイトを作った後に Astro を勧められましたが、私の学習が足りなかったのか、かなり辛い経験でした。AI エージェントに全部任せないとうまく動かず、静的コンテンツをうまく作れた記憶がありません。

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: バニラの HTML / CSS / JS から一歩進める選択肢として AI に勧められました。
- 👍 良い点: そこそこメジャーなフレームワークだとは思いますが、正直まだよく把握できていません。
- 👎 ダメな点: 非エンジニアが触るにはハードルが高く、かなり苦労した印象があります。
- 👥 誰向けか: 継続的にコンテンツを管理・更新していきたい人向けだと思いますが、私はまだ掴みきれていません。
