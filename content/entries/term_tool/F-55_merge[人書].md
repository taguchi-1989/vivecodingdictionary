...
-
-あ、なんか単純なとこの回しだったらいいんだけど、なんかね？昔解決できない。コンフリクトが起きてマジできなくなって、そのブランチ丸ごと振ってることかっていうのがでなんかそのエラーもなかったね。そのVS 無駄にしたってもあったな。ま。あと、最近だとあの逆にこうコストが低いので、あんま見なくなっちゃうよね
-

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象:なんかくっつけんだろうなって感じ
- 👍 良い点:並列した開発を取り込むっていうところに、こうまハードルがあるというか、見方してあるのはまあそうだよね。ってところ
- 👎 ダメな点:にま素直に回してない時あるよね。これはこれが問題というかはそこの開発が問題なんだけど
- 👥 誰向けか:運用するとしたら必要だよね。ちゃんとして
