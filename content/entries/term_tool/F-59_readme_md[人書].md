...
-何が書いてあるか書いてあるんだけど、なんか真面目に容器に毎回なんないんだよね。で、特に英語で書いてる時とかなんかよく気にならないというところ。あと昔だとドット MD って書いてあったところの MD にすごい抵抗があってなかなか分かるんだけど、触る気にそもそもなれなかったって感じかな。なんか作り方がちょっと微妙にだよね。自分で書いてるところ取り込むとか取り込まないとか。そんなとこ無視を待ってなんかね。ちょっと微妙な感じがするね
-
-
...
- 🙂 第一印象:初めに読む。ドキュメントだけで読む気しない
- 👍 良い点:エージェントが基本的に作ってくれたりするので、あんまり自分で触んなくても実は良くなった
- 👎 ダメな点:バージョン管理うまくできてないと古い情報が残ったりするので、まここの管理方法は結構課題
- 👥 誰向けか:アプリケーションを作る人使う人どっちもじゃないか
