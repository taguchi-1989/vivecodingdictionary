...
ブラウザで 3D を手軽に描けるライブラリです。WebGL（ウェブジーエル）の複雑さを隠す高レベル層です。

<!-- ━━━━━━━━ 左ページ ━━━━━━━━ -->

## 何をしてくれるか

3D モデルの読み込み・光源・カメラ・アニメーションを JavaScript（F-1）で操作できます。WebGL 直書きに必要な行列計算やシェーダ言語の知識を省略でき、数行で立方体を表示できます。
...
-なんかよくわからんけど、3 D これを知ってるだけで、その3 D で動くというかま見れたり、ちょっといじれたりするのができるっていうのがまこれ初めてした時すげえなって。これただで使えるとか。マヤに任せれば動かせるってので、ま非常に感動したけど、ブラックボックスになりやすい
-
-
...
- 🙂 第一印象:3次元のやつユニティとかじゃなくても作れるんだ。すごい
- 👍 良い点:表現方法がま非常に多彩だよね。えっとま使いところによってはま非常に高品質なもんできる
- 👎 ダメな点:ブラックボックスしやすくって自分でこう中のとこちょっと変えるとかってのはちょっとした直しがかなり厳しいよね。ま嫌に楽しめばいいかもしんないけど
- 👥 誰向けか:これは色々やりたい人向けかな？私狙いとしてはなんかモデリングモデルベースのデジタルツ、イン的なものを目指せないかなとは思ったりしてるのよね。事前検証とかができるようなベースにできればなあと思ってたりしてるかな？
