...
-htm ファイル単独でできないことも中に CSS とか JavaScript とか入れたりとかしてオールインワンの結構出せたりするので結構ね。範囲が分かりづらいなっていう風には思う。あと、パッと見てソースコードを見て何か書いてあるのかって、えっと結構辛いよね。っていうところ、タグの使い方があるなっていう風に思うところかな
-
-
...
- 🙂 第一印象:Web で使われる言語
- 👍 良い点:あ、パッケージングして配布すれば軽いファイルでいろんなことができるかな？ファイルにできるのでまやりやすかったりする
- 👎 ダメな点:セキュリティのところとどこまで htm ファイルに含めるのかとかってのは設計がちょっと難しい時はあるよね
- 👥 誰向けか:今後受け渡したりとか人は確認してくんだったら、ここの形式なんじゃないかな
