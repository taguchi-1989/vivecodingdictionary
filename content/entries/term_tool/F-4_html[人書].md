...
- HTML ファイル単独ではできないことも CSS や JavaScript を中に書き込めばオールインワンでかなりのことができますが、そのせいで「HTML の責任範囲」が分かりにくくなります。
- ソースコードをパッと見て何が書いてあるか読み解くのが辛く、タグの使い方を覚えるのに時間がかかりました。

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: Web で使われる言語という認識でした。
- 👍 良い点: 単一ファイルにまとめて配布すれば軽く動くものが作れる点は使いやすいです。
- 👎 ダメな点: セキュリティや「どこまで HTML に含めるか」という設計判断が難しい場面があります。
- 👥 誰向けか: ファイルを受け渡したり確認したりする人にとって、この形式が最も扱いやすいと思います。
