...
-AWS の最初の設定のところで、つまづいて、えっと MCP のところに行くまでのところでつまづいてるかな？ていうのと AWS やりたいところの概念がわかんないと、 MCP でこういう風にやっていいですか？って言われてもちょっとわかんないから、 AWS 自身の勉強は必要そう
-
-
...
- 🙂 第一印象:I AWS を MCP あるからAI エージェントと対話する中で用件積めれば使えそう
- 👍 良い点:おそらく操作はポチポチやらずに済む
- 👎 ダメな点:AWS 自体の知識が多少必要
- 👥 誰向けか:企業向けで AWS の環境構築する人かな
