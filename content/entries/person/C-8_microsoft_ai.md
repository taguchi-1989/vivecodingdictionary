...
GitHub Copilot（ギットハブコパイロット）・Microsoft 365 Copilot・Copilot Studio など Copilot 系プロダクト群を統括します。Azure（アジュール）上で OpenAI モデルを企業向けに提供する Azure OpenAI Service も管轄します。

## どこで出会うか

GitHub Copilot などを使う場面で裏側の組織として名前が出ます。AI 業界ニュースでは OpenAI との提携動向や Phi 系（ファイ系）モデル発表の文脈で登場します。
...
-何かがあったらすぐ課金っていう。 Microsoft の企業体質みたいなところがまコパイロットのところにま現れてるなってところ
-料金体系のところとかに迷いを感じるよね。 git で使ってるところの利用のところもそうだし、一般のところのコパイロットもま有料無料のプランあるけど、あれ？無料のプランもいつ有料化されるのか？ってのも結構不安な部分あるな
-
...
- 👎 ダメな点:モデルの性能は低すぎて、基本的にフロンティアに比べてま半年から1年遅れの実力っていう風に最近改善しつつあるが
- 👥 誰向けか:会社に使えって言われてる人
