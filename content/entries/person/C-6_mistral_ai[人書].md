...
- 会社名（Mistral AI）と代表モデル名（Mistral 7B / Mixtral）がほぼ同じで、会話の中で「どっちの話？」となりやすいです
- 「Mistral」という単独の単語が文脈で会社かモデルかに振れるので、記事を読むときに頭の中で読み替えが要ります
- D-41 Mistral 系モデルのページとも内容が近接するので、企業の話なのか個別モデルの話なのか、辞書を引いた瞬間に整理しづらいです
