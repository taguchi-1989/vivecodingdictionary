...
Meta（旧 Facebook）の AI 研究・製品部門です。Llama シリーズを OSS で公開し、機械学習フレームワーク PyTorch の開発元でもあります。
...
- Llama は OSS で配布されていますが、大きいモデルを動かすには GPU 等のリソースが必要で個人では大変です
- ザッカーバーグが力を入れていたメタバースはそもそもどこへ行ったのか、戦略の流れが追いきれません
- Facebook や Instagram の運営元という背景があり、個人的にはあまり好きになりきれない気持ちもあります

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: GAFA の一角という大きな存在として認識していました
- 👍 良い点: Llama などオープンウェイトのモデルを配り続けている姿勢には独自性があります
- 👎 ダメな点: Qwen（Alibaba 系）など他のオープンモデルと比べ、優位性も存在感も薄く感じます
- 👥 誰向けか: Facebook 全盛期を覚えていて、Meta の AI 動向を追いたい世代向けです
