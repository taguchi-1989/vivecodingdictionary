...
-地味に2.5。フラッシュイメージジェネレーションていうのがま長くって。えっと7のバナナ Pro だったけどまそう。モデルの名前入れる時に API とか入れる時にどれを選択すればいいのが難しかった
-ジェミニで使う時に画像生成して欲しいのに、うまく生成されなかったり、とかそんなのがなんか不安定だった
-

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象:それまでのモデルにそれまでの行かれて蓄積進化なのに、なんか過大評価されての印象だった
- 👍 良い点:使えるっていうので、0からキャラクター作る時とかには十分な性能があった
- 👎 ダメな点:日本語を入れるのが苦手なので、資料作りとかには使えないかな
- 👥 誰向けか:日本語を入れるのが苦手なので、資料作りとかには使えないかなまここはえっとまクリエイターで案を出すとかってところに使うんじゃないかな
- ナノバナナ2とか7番なプロはかなり日本語も上手になってきて、えっと文字化けもするけど、まかなり感動はしてますね。これはかなりのところがあったっていう印象
