...
Gemini 3 系のマイナー更新版です。コーディング精度と長文処理の改善が中心とされています。

## 何をしてくれるか

Gemini 3 系と同じ Pro / Flash / Ultra / Nano の系列を維持しながら、コーディング性能や長文 Context（コンテキスト）での精度が向上したと発表されています。レイテンシの短縮と料金体系の見直しも含まれるとされています。

## どこで出会うか

Google AI Studio や Gemini アプリで「Gemini 3.1 Pro」などの表記として選択肢に現れることがあります。AI コーディングツールの対応モデル一覧や、SWE-Bench（コーディング評価指標）の比較記事でこの名前に出会うことが多いです。
...
コーディング精度と長文処理が向上し、より複雑な依頼に対応できるとされています。

### 3. 注意点

3 系とは別物ではなく同系列の改良版なので、大きな変化は限定的です。

### 4. どこで役立つか

長い Context を扱うコード生成や文書要約の場面で効果が出やすいとされています。
