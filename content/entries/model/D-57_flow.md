...
-ジミニのプロプランである程度使えるって言うなるけど、ま回数がこう。上限決まってるので、ま気軽にはなんか使いづらいような感じ
-がクレジットベースで使われていくけど、まどこまでどうできるのか？ところがなかなかイメージつきづらかった
-

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象:Google のプロプランであれば、地面と一緒に回数内で使えるっていうとこ
- 👍 良い点:Google のエコシステムシステムの中にの1つとして入れられてるってとこ
- 👎 ダメな点:本格的に使ってないから何ともだけど、まクレジット相当消費そうな感じはある
- 👥 誰向けか:動画編集する人向けかな？新しいものを目指していく人かな
