...
Veo と Imagen を束ねた Google の映像制作スタジオです。テキスト・画像から動画クリップを生成します。

<!-- ━━━━━━━━ 左ページ ━━━━━━━━ -->

## 何をしてくれるか

テキストや画像から動画クリップを生成するツールです。Scene Builder（シーンビルダー）でシーン構成、カメラアングル指定、Asset Management（アセット管理）を 1 画面に統合しています。


## どこで出会うか

Google AI の有償プランである AI Pro や AI Ultra に同梱され、Web ブラウザから利用します。API 中心の開発者向け Veo とは異なり、クリエイター層が映像を組み立てる入口として登場します。
