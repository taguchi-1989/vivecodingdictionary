...
- 🙂 第一印象:オーパス4.5レベルとかかなり評判がいいよ。くってえっとオープンモデルっていう風な触れ込みで聞いた
- 👍 良い点:オープンクロードの相性が良くって、自分でエアエージェントのハーネスを組む時にやっぱ推奨されてるのが一番一番推奨されてるイメージ
- 👎 ダメな点:マシンパワーと情報漏洩かな
- 👥 誰向けか:オープンクローでエージェントハーネス作り、自分で作りたい人の系全て
