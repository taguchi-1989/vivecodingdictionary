...
- チームで開発しているわけではないので、この概念は個人開発だとなじみにくいと感じます。
- 
- 
...
- 🙂 第一印象: SE の人がやる進め方だなという印象です。
- 👍 良い点: 通常のエンジニアリングスタイルだと効率が上がっていくのかなとは思います。
- 👎 ダメな点: バイブコーディングとの相性は正直良くないと感じます。AI エージェントと組み合わせればよいので、人手でやる必要性が薄れてきている気がします。
- 👥 誰向けか: AI エージェントを使わない旧来スタイルの人向けではないかと思います。
