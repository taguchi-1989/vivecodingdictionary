...
-何の略称かわかんないし、何に効くのかはわかんない
-プルリクごとに走らせまくるとなんかすごい数走ってってギフトハブアクションズとかの無償期間結構すぐ超えちゃう
-
...
- 🙂 第一印象:何言ってるかわかんない
- 👍 良い点:AI が書いたコード AIS のは書いたコードを監査するにはま必要な必ず必要というかのベストブラック1つ必要なところになってくる
- 👎 ダメな点:ちゃんとこうローカルでバグチェックしてから出さないといけないよね賢いモデルである程度やってないと
- 👥 誰向けか:全てバイブコーディングする人
