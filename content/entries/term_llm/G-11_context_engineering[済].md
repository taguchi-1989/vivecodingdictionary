...
- エージェントタスクを追っている人は「コンテキスト」という言葉を当たり前に使うが、触っていない人には全く通じず、自分も衝撃を受けた。
- まだ一般名称ではないのに一般名称化していると思い込む人も出始めていて、両側の温度差を踏まえた理解が必要。
-

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: チャットから一歩進めようとすると文脈が必要で、その気づきと一致する言葉だったので「当然必要」と思った。
- 👍 良い点: 真に必要なことを渡せば、AI 側のカスタマイズが効き、狙った出力を得やすい。
- 👎 ダメな点: 実は一番コストがかかる部分で、ここが一番のボトルネック。
- 👥 誰向けか: 組織で運用していく人は、ここがボトルネックだと認識しておかないといけない。
