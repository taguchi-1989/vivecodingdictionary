...
- モデルの賢さを語るとき「ワンショットの賢さ」「コーディングが賢い」と言われるが、その意味が分からないと文脈を追えない。
- 「エージェントタスクには向かない」のような限定的・ネガティブな表現とセットで使われがちで、チャットしか触っていないと概念が掴みにくい。
-
...
- 👍 良い点: 通常のチャットや HTML ファイル生成など、非常に賢い出力が出てくることはある。
- 👎 ダメな点: 長期タスクとは別の能力だと認識しないと誤解する。
- 👥 誰向けか: エージェントタスクを委任する人は、ワンショット性能と長期タスク性能を別物として踏まえる必要がある。
