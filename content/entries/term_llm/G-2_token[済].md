...
- なんかパケットみたいなもんだとは思うけど、何の単位になってるかが分かりづらいよね。
- 英語と日本語でも消費が違うし、見えてる入力トークンとは別に、裏で Thinking が動いてるトークンもあったりする。
- 量も単価もわかんないから、結局いくらかかるのかの価格感が掴めない。

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: LLM のパケットみたいなもん。触ってれば必ず出てくるやつ。
- 👍 良い点: 通貨的な感じで使えるよね、「いくら使った」を測る単位として。
- 👎 ダメな点: 課金方式が分かりづらく、Prompt Caching も裏に乗るので値段が読めない。
- 👥 誰向けか: 最近の時代に AI を触る人だったら、全員が押さえててもいい単位。
