...
- 1 人でやっているならメインで全部やればいいので、最初に必要性を認識するところが少し難しい。並列で回していく仕組みが必要、と分かって初めて意味が見えてくる。
- 複数並行で進めていると、どこで作業していたか忘れてマージし損ねる。今の Worktree を視覚的に追う拡張機能のようなものがないと難しく、今後の課題になりそう。
-

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: 衝突しないのが良い。メインで複数並行して衝突した経験があるので、この仕組みは良いと思った。
- 👍 良い点: タスクベースで切れるところ。
- 👎 ダメな点: 1 人でやっているとタスクが混ざることが結構ある。チームでやるとき、どの粒度で切るか、今の課題をどう管理するかが課題になりそう。
