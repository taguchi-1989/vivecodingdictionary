...
- 昔めちゃくちゃ流行り、古い AI の本では「こう指示するのがいい」と書かれている。
- 今のモデルでやるとトークンを無駄遣いするだけで、何もいいことがない。
- 「昔は必要、今は不要」という歴史的な文脈で説明するコストが面倒。
-

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: これで AI の出力を賢くできるんだ、と思った。
- 👍 良い点: 昔は実際にスコアがすごく上がり、手元でできるハック的な手法として良かった。
- 👎 ダメな点: 今は使えない。モデルに組み込まれていて、もう要らなくなっている。
- 👥 誰向けか: 昔のモデルを使う人向け。ローカル LLM の量子化モデルでも今は不要なレベル。化石を扱う歴史研究者くらい。
