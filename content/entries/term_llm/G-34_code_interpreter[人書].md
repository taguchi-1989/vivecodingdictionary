...
- 「LLM は計算ができない」と思っている人が出てきて、このパラダイムに苦労している印象を受ける。
- Python の計算が裏で走っているという伝え方が難しく、Python に触ったことがない人には「中で何が動いて結果が出ているか」を概念的に押さえてもらわないと説明が長くなる。
-
...
- 🙂 第一印象: 革命的だと思った。
- 👍 良い点: Python のコードを書けばいいので、人より計算が上手い。特に今は強い。
- 👎 ダメな点: ドキュメントで結果を確認する必要があり、文字だけだとつらいので Mermaid 図のようなブロックで確認するなど、確認・効率化の仕組みと合わせないと大変になる。
- 👥 誰向けか: 科学技術計算だけでなく、Excel を使っている人はみんな恩恵を受けられるはず。
