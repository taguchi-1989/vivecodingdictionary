...
- パケットみたいなものだと思うけれど、何の単位なのかが分かりづらい。英語と日本語でも切り方が違う。
- 見えているインプットのトークン、アウトプットのトークン、内部で思考しているトークンと種類があって、それぞれが動的に増減するため価格感が掴みにくい。
- 量も単価も分からないので、結局よく分からないまま使うことになる。

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: LLM とパケットのようなやり取りをしていると、必ず出てくるイメージ。
- 👍 良い点: 通貨的な感覚で使える。
- 👎 ダメな点: 計算式が分かりづらいし、裏に乗っかっている（思考トークンなどの）部分が見えないので分からない。
- 👥 誰向けか: 最近の時代に生きる人なら、ほぼ全員が押さえてもいい。
