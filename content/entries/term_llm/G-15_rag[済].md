...
- 2〜3 年前にめちゃくちゃ流行ったが、最近は RAG を「固有の技術」として持ち上げるのが微妙になってきた。
- ソースを引っ張る検索チャットボットを「まっすぐ作れる」と飛びついて構築しても、モデルが高性能化していくので、昔チューニングしたものは陳腐化していく。
- 簡単に実践できる反面、「これが本質なのか？」という思いがあり、つまずくというよりモヤモヤする。

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: すごい、何でもできそうだし、チャットボットも簡単に作れそう。
- 👍 良い点: 実際にチャットボットはそこそこのものができた。
- 👎 ダメな点: 全部入れていくとどんどん劣化する。結局 MoE 的なエキスパートシステムとのハイブリッドにしないと、全部突っ込んでも出てこないし、検索に引っかからないと弾かれる。すごく使いづらい。
- 👥 誰向けか: AI レガシーシステムの代表になりつつある印象。
