...
-
-これ自分で定義してやるような／ コマンドとえっとデフォルトであるよな。クロードコードのやつとでこれはね。 VS コートで使えるコマンドとコードにデスクトップで使いやすとのが違ったりするから、このコマンド使えばいいって結構あるんだよね。特に最近だとウルトラレビューとかなんか使えるレポート使えないやつがあったりとか。してどんな皿でここが生じてのかわかんない。あと自分で作った／ コマンドもなんかこういうのやりたいなって言って作っといてってコードでやるとなんか自分で打ってないからね。自分じゃ使えないんだよね。だからそこは譲ってるかは多分全体やりたいことのハーネス化してしまって、この中でこれを必ずやるとかって発火させるとかっていう。風にやんないとなんかね？部分最適になっちゃう感じがすんだよね
-

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象:ちょっととっつきづらそうなんか黒い画面触ってる人が好きそう
- 👍 良い点:指示をこうまとめられるようなショートカット的な使い方ができるよね
- 👎 ダメな点:自分で作んないと何できるのかわかんないから。っていうところと環境によって使える使い
- 👥 誰向けか:自分でコマンド打って進める人かエージェントにバリバリにする人どっちかかな
