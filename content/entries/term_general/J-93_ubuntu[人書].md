...
無償で使える Linux OS（オペレーティングシステム）の一つです。Canonical 社が 2 年ごとに LTS（長期サポート）版を出し、安定運用なら LTS、新機能優先なら通常版と選べます。
...
-まず何て読むのかわかんないし、全く聞いたことないしっていうところから始まると思うし、リナックスっていう中の一部が右っていうのの、この位置付けが分かりづらいよね
-
-
...
- 🙂 第一印象:読めない
- 👍 良い点:Windows なくってそこの何だろうなくってパソコンの OS として機能できるところ
- 👎 ダメな点:知識やっぱ多少必要になるよね。使ってくには
- 👥 誰向けか:サーバーとかコストを抑えたい。人向けと AI エージェントが使ってきたい人とかロボット OS とか使ってきた人とか
