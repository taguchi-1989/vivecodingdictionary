...
- 名前は聞いたことがありますが、仕組みを理解するには従来の機械学習やディープラーニングの限界をまず押さえた上で、なぜこれが必要なのかというところを掴まないと何がすごいのかわかりません。
- 
- 
...
- 🙂 第一印象: かっこいい名前だなと思いました。
- 👍 良い点: Attention 機構で、これまでのボトルネックを一気に超えているところが良いです。
- 👎 ダメな点: Transformer だけではなく、今の LLM はさらに様々なものを組み合わせているので、そこまで理解しないと全体像がつかめません。
- 👥 誰向けか: LLM の仕組みをちゃんと理解したいなら必要な概念だと思います。
