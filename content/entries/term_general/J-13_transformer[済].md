...
- 名前は聞いたことがあっても、それまでの機械学習やディープラーニングの限界点と、それを Transformer がなぜ突破できたのかを押さえないと、何がすごいのかが伝わりません

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: 名前がかっこいいモデル、という印象です
- 👍 良い点: Attention 機構で、それまでのボトルネックを一気に超えた点が革命的です
- 👎 ダメな点: これ単体だけでは現代の LLM にはならず、他の工夫を積み重ねないと完成しないので、そこまで含めないと理解が浅くなります
