...
- ビットコインのマイニング用途で流行り、本来ゲーム用なのにマイニング、最近はローカル LLM 推論、と用途が広がりすぎて把握しづらいです
- RTX シリーズは Quadro シリーズと混同しがちです（昔の 4000 番台あたり）。Quadro はもう無くなりましたが、ゲーム用と学習用を兼ねるモデルとして RTX が残っています。40 世代、50 世代と並ぶと違いが追えなくなります
- RTX 2070 Ti が強かった世代の記憶が強く残っているので、いまの 50 世代を聞くと「随分先まで来たな」という感じです

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: レイトレーシングのゲーム用、という印象でした
- 👍 良い点: ゲーム用からローカル LLM の学習・推論まで幅広く使える点
- 👎 ダメな点: 最近は値段が高騰しすぎている点
- 👥 誰向けか: ハイスペック PC を使う人。今のゲーム用モデルとして見ると一般層からは縁遠い水準になっています
