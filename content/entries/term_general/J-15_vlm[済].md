...
- LLM と混同しやすいです。ロボットのビジョン関連で使われたりしていますが、モデルの種類が混在してきているので切り分けが難しくなっています。
- 
- 
...
- 🙂 第一印象: ロボットのビジョン関連の文脈で初めて知りました。
- 👍 良い点: LLM と切り分けて話せる概念として使えます。
- 👎 ダメな点: LLM もある中でさらに VLM まで出てくると、日常会話では出しにくくなります。
- 👥 誰向けか: ロボットや AI 活用をしっかりやっていく人向けだと思います。
