...
- LLM とごっちゃになりやすく、ロボット文脈やビジョン処理の組み合わせで使われたりもします。実際のモデルがマルチモーダル化していて、用語としての切り分けが難しくなっています

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: ロボットのビジョン文脈で初めて知った言葉です
- 👍 良い点: 言語モデルと視覚モデルを切り分けて議論したいときに、用語として正確に指せる点が良いです
- 👎 ダメな点: LLM ですらまだ口に馴染まない中、VLM を日常会話で使うのはさらにハードルが高いです
- 👥 誰向けか: ロボットや業務プロセスへの AI 活用を推進する人で、用語を厳密に使いたい人向けです
