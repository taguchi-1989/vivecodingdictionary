...
- 2025 年あたりからメモリ価格がむちゃくちゃ高騰し、ものによっては倍以上になっています。ここで本当につまずく場面が増えました
- Claude Code でマルチエージェント・オーケストレーションを回そうとするとリソースを相当食うので、私も 32GB では足りず 64GB に増設しました（差額で 8 万円ほどでした）
-
...
- 👎 ダメな点: 増設できる枚数が決まっており、メモリは同型番を揃える必要があるため、4 枚刺しなら 4 枚同時に買わないと相性問題が出ます
- 👥 誰向けか: マルチエージェントを動かす人は特に。基本的にパソコンを使う人は全員、意識する話です
