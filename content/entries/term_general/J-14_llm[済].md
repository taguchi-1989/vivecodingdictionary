...
- 🙂 第一印象: 生成 AI のうち言語をまとめて扱うものを「大規模言語モデル＝ LLM」と呼ぶのか、と認識したのが入り口でした
- 👍 良い点: ひとくちに「AI」と言ったときに解像度がぼやけがちな部分を、LLM という言葉で切り出して語れるところが良いです
- 👎 ダメな点: 日常会話で「LLM」と言う人はまだ多くなく、相手によっては伝わらず気恥ずかしくなります
