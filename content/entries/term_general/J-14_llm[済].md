...
- 🙂 第一印象: 生成 AI の文脈を Large Language Model という一つの概念で捉えることで「LLM」という名称として認識しました。
- 👍 良い点: AI と一言で言っても何を指すかの解像度を高められます。
- 👎 ダメな点: とはいえ、日常会話で LLM という言葉を使っている人は多くないので、かえって「何それ？」となりやすいです。
- 👥 誰向けか: AI についてそこそこ詳しい人向けの言葉だと思います。
