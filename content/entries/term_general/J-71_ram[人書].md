...
-昔に比べて2025年ぐらいからメモリーがむちゃくちゃ高騰しててものによってこうバイト化してるので、まここは本当につまずく科学館がつまずく
-ロードチェイスでマルチオーケストレーションとかをクロードコートがコネクステしようとするとここやっぱえっとリソースで相当使うのでえっと私は3。2で足りなくなって6。4に増設して、それに8万変わった
-

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象:パソコンのスペックを測る指標の1つやね
- 👍 良い点:高ければパソコンが基本的にサクサク動く
- 👎 ダメな点:増設できる数が決まってるし、えっとメモリカードも同じものを刺さないといけなかったりするし、4本挿しするんだったら4本。いっぺんに買わないと相性問題とか発生するし、結構厄介
- 👥 誰向けか:マルチオーケストレーションとかでやる人は特にかな？全員じゃない？パソコンかかる人
