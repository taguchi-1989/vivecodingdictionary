...
- 少し詳しい記事に出てきますが、略称だけ見ると何の略かパッと浮かびにくいです。GPT-4 系列でも使われているという噂がありますが、クローズドモデルでは本当に使っているかどうかが確認できず、ずっと予想にとどまってしまいます。
- 
- 
...
- 🙂 第一印象: なぜ GPT-4 が賢いのかという話をしたときに想定として出てきました。
- 👍 良い点: 賢さとコストを両立できるところがブレイクスルーだと思います。
- 👎 ダメな点: エキスパートの区切り方が実際には難しいです。
- 👥 誰向けか: 概念的に理解しておくのはみんなに必要だと思います。
