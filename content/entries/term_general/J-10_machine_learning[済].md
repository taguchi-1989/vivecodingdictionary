...
- 「AI を入れています」と謳う事例の多くは、特に 2025 年より以前は機械学習レベルの話で止まっているケースが多く、相手とどのレベルの話をしているのか認識を合わせるのが難しいです

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: 最初は難しく感じましたが、原理を押さえるとそこまで難しくない、という感覚です
- 👍 良い点: 自分で再現でき、原理を理解に落とし込みやすいところが良いです
- 👎 ダメな点: LLM 文脈と紛らわしく、何を指しているかが曖昧なまま使われがちです
- 👥 誰向けか: データサイエンスを本気でやる人にはもちろん必要ですが、現代の利用者全般にとっても土台として押さえておきたい用語です
