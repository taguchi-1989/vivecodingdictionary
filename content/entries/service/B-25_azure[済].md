...
- Microsoft のサービスを使っていても「Azure」という単語や「クラウド上で動いている」という概念の説明が難しいです。共通認識がないと会話が噛み合わなくなりやすく、名前の読み方（アジュール？）の時点で詰まることもあります。
- 
- 
...
- 🙂 第一印象: AWS の代替として、Microsoft エコシステムに統合されている点は良いと思いました。
- 👍 良い点: クラウドとして良い部分はあります。シェアも高くなってきています。
- 👎 ダメな点: 他の Microsoft サービスがいまいちなのでその影響が出る部分があります。また ChatGPT 経由の MCP と Microsoft の MCP がコンフリクトしているので、この辺の見極めが大変です。
- 👥 誰向けか: Microsoft 製品を使っている人は知っておくべきだと思います。
