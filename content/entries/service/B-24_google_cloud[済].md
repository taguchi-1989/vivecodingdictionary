...
- GCP という名前が分かりにくく、自分の業務でどう使えば安全なのか、どんな経路でデータが流れるのかが掴みにくいです。Vertex AI を使うときも同様で、エンタープライズ活用の実例はあっても、いざ自分で使うときに何をどう踏んで契約すればよいのかが分かりにくいです
...
- 👎 ダメな点: 実際の手順が分かりにくく、Google 以外の API を Bedrock 経由などで併用しようとすると面倒です
