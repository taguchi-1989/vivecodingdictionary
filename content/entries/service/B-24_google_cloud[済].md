...
- GCP という名前がわかりづらいですし、どの経路で使うのが良いのかがわかりにくいです。Vertex AI を使う場合も同様で、エンタープライズ活用がどの程度できるのか、どういう手順で契約するのかなどがよく見えません。
- 
- 
...
- 🙂 第一印象: API で Google の LLM を安全に使えるならいいなと思いました。
- 👍 良い点: セキュアな提供が期待できると言われています。
- 👎 ダメな点: そのやり方がわかりづらいのと、Google 以外の API だと経由が増えて面倒です。
- 👥 誰向けか: API でセキュアに開発したい人向けだと思います。
