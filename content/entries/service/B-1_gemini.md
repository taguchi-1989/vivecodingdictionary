...
Claude と並ぶ主役級のサービスです。同じブランドの下に、企画・開発・業務・個人利用と複数の顔があります。
...
Google Workspace と深く統合され、Docs／Gmail から自然に呼べます。

### 3. 注意点

サービス名・モデル名・API 窓口が同じ「Gemini」の下に並び、会話がずれやすい。

### 4. どこで役立つか

会議メモ要約、長い PDF の読み込み、Android の音声操作、Cloud 上の業務組み込み。
...
Gemini 2.5 系、Vertex AI、AI Studio、Workspace 個別機能、Context Window。
