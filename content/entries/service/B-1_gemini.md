...
自然言語で話しかけると、要約・調査・コード生成・画像理解などを返してくれます。同じ「Gemini」でも入口で体験が違います。

- gemini.google.com：ブラウザの無料チャット
- Google Workspace 統合：Gmail、Docs で「横に AI がいる」体験
- AI Studio／Vertex AI：開発者向け API 窓口
