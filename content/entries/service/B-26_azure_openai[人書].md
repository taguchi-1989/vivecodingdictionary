...
-
-クラウドが安全かサースが安全かみたいな。議論の時にどこにデプロイされてるとかどこにいてとかっていう仕組み、インターネットのその兵器の中なのか、外のインターネットなのかっていうところとかこの辺のね。形の考え方ってのが分かりづらいんだよね。あの回線光 wi-fi に繋がってれば全部外に繋がってるとかっていう風に思ってしまったりするんだけど、そうじゃないよ。って説明するとか理解するのって結構しんどかったりするよね
-

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象:チャット GPT の API API 利用として企業内部で使えるっていう仕組みが構築が比較的簡単できるので要因だろうな
- 👍 良い点:チャット GPT を重量課金でサービスを16課金で使えること
- 👎 ダメな点:ちょっとラグあるよね。えっとチャット GPT のサービス開始とアジュールのところまでの。ちょっとま1週間2週間程度だけど、ラグがあるイメージ
- 👥 誰向けか:API 課金で使いたい人全員じゃないかな？結構企業の中で説教に使いたい人とかも
