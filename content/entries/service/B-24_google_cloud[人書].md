...
-GPC っていう名前が分かりづらいで、これが石油なのか。どんな経路で使ってるからいいのかとかってところが分かりづらい。パーテクス I 使う時も同様でエンタープライズ活用がどの程度できるのか、なんか実例あるけど、自分で使ってく時にどういう風な手順をどういう風に踏んでて、どうやって契約すればいいのかとか
-
-
...
- 🙂 第一印象:API で Google のエレルーム安全に使えるんだったらいいな
- 👍 良い点:提供すると言われている
- 👎 ダメな点:そのやり方が分かりづらいのと、 Google 以外の API とかベッド経由になると結構面倒
- 👥 誰向けか:API でセキュアに開発してきた人向けかな
