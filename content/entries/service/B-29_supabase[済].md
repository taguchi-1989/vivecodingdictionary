...
- データベースという概念と Authentication ができるということの何がメリットなのか、最初はよくわかりませんでした。SQL エディターで書いて実行するという流れも、既存のテーブルとの関係など、概念を理解しないと挙動が難しいです。
- 
- 
...
- 🙂 第一印象: LLM がデータベースを無料で使えるということで紹介されていたサービスです。
- 👍 良い点: 慣れてしまえば比較的楽です。バックエンドの操作や CLI 操作もできますし、AI に委任もできます。
- 👎 ダメな点: 初期のとっつきにくさがあります。
- 👥 誰向けか: 個人サイト運用をやっていく人向けだと思います。一定規模の運用ならこれで十分ではないでしょうか。
