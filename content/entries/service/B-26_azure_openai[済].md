...
- 
- クラウドが安全かSaaSが安全かという議論のとき、どこにデプロイされているかという仕組みや、内部ネットワークと外のインターネットの違いがわかりづらいです。Wi-Fi に繋がれば全部外に出ると思ってしまいがちですが、そうではないという説明が難しいです。
- 

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: ChatGPT の API を企業内部で使える仕組みが比較的簡単に構築できるのが良い理由だと思いました。
- 👍 良い点: ChatGPT を従量課金でサービスとして使えることです。
- 👎 ダメな点: ChatGPT のサービス開始から Azure への反映まで 1〜2 週間程度のラグがあるイメージがあります。
- 👥 誰向けか: API 課金で使いたい人全員ではないでしょうか。企業内でセキュアに使いたい人にも向いています。
