...
-名前に馴染みがないよね。である程度触っていた他のサイト触ってれば大体わかってくるんだけど。とはいえ似たようなところあるんだけど。とはいえば管理サイトのところがま全部英語系なので何書いてあってどういう風に書けばいいのかとかってのがま結構ちん。ぷんぷんなりがち検索で出てくる範囲がトップページから見れる。検索と検索とかってのが検索あるっちゃあるんだけど、これがね中途半端な感じがするんだよね
-
-
...
- 🙂 第一印象:cdn でやれるところとうんとドメインを管理するのに良いサイトサービス
- 👍 良い点:NEXT JS とかの実装とかもできるし、今かなりサービス範囲を広範囲かつ割と安価な提供になってるし、 O ってなのでかなり信頼できる
- 👎 ダメな点:検索機能
- 👥 誰向けか:バイブコーダーには非常に相性いいし、特に公開するとかと最高なんじゃないかな。TOC
