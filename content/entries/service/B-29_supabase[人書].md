...
-データベースっていう概念が今のとあとオーセンティションができるっていうところって、何のメリットがあるのかって最初よくわかんなかったってのとこと、あと SQL エディターのとこですね。これの仕組み？そのエディターで書いて、あの LAN した時にランはさせるってこうをやってくんだけど、なんか選んなります。というか、まあすでにあるようなテーブルがあるよ。とかっていう風なのでね。この辺の挙動ってのがうんと概念 と か を ちゃんと 理解 し ない と 理解 が 結構 難しい
-
-
...
- 🙂 第一印象:LM がデータベースを無料ベース使うってとこで紹介してきたサイト
- 👍 良い点:運用慣れてしまえば比較的楽かな？あと、結構いろんなことができるようなイメージなんでバックエンドの操作をあと、 cli 操作もそこそこできるみたいって aiz に委任もできるかな
- 👎 ダメな点:ま処刑のとっつきづらさはあるよね
- 👥 誰向けか:個人サイト運用とかをやってく人向けかな？あれ？一定のサイズの運用だったらこれでいいんじゃないかな？って感じは
