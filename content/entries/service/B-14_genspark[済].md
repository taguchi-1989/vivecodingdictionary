...
複数 LLM と Web 検索を統合し、Sparkpage を自動生成するサービスです。
...
- いろんな機能の実装が速いです。ただ、創業者が中国の方なので情報漏洩が気になるところです。印象マーケティングをかなりやっているなという印象も受けます。
- 
- 
...
- 🙂 第一印象: 面白い軌道で動いているサービスだと思いました。
- 👍 良い点: 実装の方向性のセンスは良いと感じるところがあります。
- 👎 ダメな点: セキュリティがかなり不安なので会社では使えません。
- 👥 誰向けか: 個人向けで情報漏洩が気にならない人向けではないでしょうか。
