...
- 手書き風の見た目が個人的にはあまり好みではなく、最初の見た目で離脱してしまいがちです
- 何のために起動するのかという入口が分かりづらく、使ったことがないと触る動機が湧きません
- なんとなく Mac で作業する人が好んで使っているイメージがあり、自分の作業環境に馴染むか不安です
...
- 👎 ダメな点: Mermaid を HTML に直接埋め込む書き方との差別化点が掴めず、使うモチベーションが湧きません
