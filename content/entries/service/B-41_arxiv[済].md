...
- 論文が無料で見られるのは嬉しいですが、一方で査読前なので玉石混淆の状態で大量に出てきます。サイト内検索で目当ての論文を探すのがかなり大変です。
- 
- 
...
- 🙂 第一印象: 最先端の論文が無料で置いてあるところに魅力を感じます。
- 👍 良い点: Elicit や ChatGPT などの検索システムと組み合わせることで注目論文を追うことができます。
- 👎 ダメな点: 玉石混淆の論文があるので、全部を1から見ていくと時間がいくらあっても足りません。
- 👥 誰向けか: 超フロンティアの研究者の動向をチェックしたり、LLM で論文を要約・確認したりする人向けだと思います。早い情報を取りたい人にも良いです。
