...
-まだコピペベースのエージェントフォルダを操作できるような時代の時にはえっとそこそこあのまインデックス。 HTML 特に押さなきゃいけないとかってお作法とかね。そういうのとか、あのフォルダ構成。名前の管理とかっていうので、まそこそこ苦労した記憶がある。ベストプラクティスベースってエージェントにやらせれば何の問題もなくできることかなと思う
-
-
...
- 🙂 第一印象:自分のブログが世の中のインターネットの中に出せるっていうこと自体に感動した
- 👍 良い点:比較的無料でから始められるってのと比較的操作簡単な方かな
- 👎 ダメな点:簡単とはいえ、お作法いるしっていうところ。 AI エージェントに特に初心者だとエアエージェントにやらせながらにしないと大きく難しい部分はある AI エージェントに特に初心者だとエアエージェントにやらせながらにしないと大きく難しい部分はある
- 👥 誰向けか:ブログを発信したい人。自分のメディアとかを発信した2丁目かな
