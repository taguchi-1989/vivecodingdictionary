...
-
-元々ビッグデータ解析とかの文脈で結構名前を聞いてたんだけど、昨今だともう。これとエレルームの GPC とか活用して使ってくってところの戦略であるので、なんか名前は聞くけど、いまいちどうなってんのかわかんないとか、まあと結構なんか難しいことやってその人っていう風にイメージはあるよね
-

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象:ビッグデータ解析をしている記事って最初見たかな？この単語
- 👍 良い点:Google のリソース使ってコンピューティングもえっと入れれるのをリソース使ってできるからローカルのマシン軽くできるよね
- 👎 ダメな点:契約で情報漏洩とかがちゃんとない形にするとか、機密情報のレベル管理とか、あの外の規約も確認したけど、中の規約整理とかも必要だよね
- 👥 誰向けか:Google サービス使ってビッグデータ解析入れられま活用とかしたい人向けかな
