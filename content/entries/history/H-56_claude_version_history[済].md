...
Claude のバージョン史を知ると各世代の特徴を整理できます。Haiku／Sonnet／Opus という命名体系は 3 系以降で定着しました。

## どこで出会うか

API のモデル名や料金表を見るとき世代の違いが気になります。モデル選定資料や社内相談でも版数の話題が出ます。
...
- Opus は料金が高くて気軽に触りづらく、Max プランくらいまで思い切らないと使い倒せず、各バージョンの実力感をつかみにくい印象でした

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: Sonnet 3.5 が「そこそこ賢いモデル」として話題になっていた印象です
- 👍 良い点: Opus 4.5 系のモデルは、コーディング用途でかなり手応えがありました
- 👎 ダメな点: Sonnet 4 でバイブコーディングを試した頃は、ミスが多くて台パンしたくなるほどでした。計画は立てるのに実装段階の精度が追いつかない感じでした
- 👥 誰向けか: これから Claude を触る人が、過去のバージョンがどんな実力だったかを把握する用途に向いています
