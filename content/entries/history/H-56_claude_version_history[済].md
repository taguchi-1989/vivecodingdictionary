...
- Opus が高すぎて基本的に触るのが難しく、Max プランに踏み切らないと思い切り使えない感じでした。結果としてモデルの実力がわからないまま過ごした時期があります。
- 
- 
...
- 🙂 第一印象: Sonnet 3.5 がそこそこ賢いモデルとして話題になっていた印象があります。
- 👍 良い点: Claude 4.5 のモデルはかなり確かな実力があると感じました。
- 👎 ダメな点: Sonnet 4 でバイブコーディングしたとき、ミスが多くて台パンしたくなるくらいでした。計画は立てるのですが実装がポンコツでした。
- 👥 誰向けか: 今から Claude を触り始める人が昔どんなモデルだったかを振り返るのに良いと思います。
