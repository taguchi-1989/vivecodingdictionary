...
- Claude Code を先に触っていると CLAUDE.md との使い分けに困ります。エージェントで動かそうとすると、同じようなことを書いてしまいがちで混乱します。
- 
- 
...
- 🙂 第一印象: CLAUDE.md と同じような感じだなと思いました。
- 👍 良い点: 複数エージェントにまとめて指示ができます。
- 👎 ダメな点: どこまで書くかが鍵ですよね。CLAUDE.md と同様に書きすぎると管理が大変になります。
- 👥 誰向けか: バイブコーダー全員が知っておくべきだと思います。
