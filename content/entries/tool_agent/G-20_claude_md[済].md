...
- 大事なことを全部書き込むとコンテキストが膨らみ、モデルの賢さが下がる・運用が難しくなる、という落とし穴があります
- そもそも「.md」というファイル形式自体に馴染みがありません

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: ここに書いておけば Claude に伝わるらしい、楽だな、という印象でした
- 👍 良い点: プロジェクトの方針・ルールをファイルに切り出して、Claude に運用させる「指示書」として活用できるところが良いです
- 👎 ダメな点: 詰め込みすぎると逆効果になるので、サブエージェントやスキルとの委任体系を設計する必要が出てきます
- 👥 誰向けか: バイブコーディングをする人、特に Claude Code を使う人にとっては必修の概念です
