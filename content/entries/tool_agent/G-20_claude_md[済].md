...
- どこに置けばいいかわかりませんし、何を書けばいいかもわかりません。
- 大事なことを全部書くとコンテキストが爆発してモデルが賢くなくなったりと運用が難しくなります。
- そもそも MD（Markdown）が何かわからないという人もいます。

<!-- AUTHOR: user_only / AI-ASSIST: no -->
## 私のコメント

- 🙂 第一印象: ここに書いておけば伝わるらしい、便利だなと思いました。
- 👍 良い点: AI にどう動いてほしいかを示せるのが良いです。
- 👎 ダメな点: サブエージェントやスキルの委任体系を設計する必要があることが難しいです。
- 👥 誰向けか: バイブコーダーなら知っておくべきですし、特に Claude を使うならほぼ必須だと思います。
