...
- 設定ファイルを直接触ろうとしてもどう書けばいいかわかりません。AI エージェントに「こういう設定にして」と頼んで登録してもらっても、どこにどんな設定が入っているかが可視化されていないと把握できません。
- 
- 
...
- 🙂 第一印象: 実態として初めて認識しました。
- 👍 良い点: Hooks やスキルの発動、権限などを設定できます。
- 👎 ダメな点: 存在に気づくまでに時間がかかりますし、ちゃんと理解しないと難しいです。
- 👥 誰向けか: バイブコーダーなら全員知っておくべきだと思います。
