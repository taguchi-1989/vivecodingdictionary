...
-セッティングファイルを生で触ろうとするとどう書いていいか全然わかんない。一方でエアエージェントで工場やり方やりたいよっていう風にやってセッティングジェイソンに登録してくれるんだけど、どこにあるかが分からない。どこにどういう風に設定してるのか？ってのが解決てないとわかんない
-
-
...
- 🙂 第一印象:実態として初めて認識した
- 👍 良い点:フックスやスキルの発動などを権限などの設定ができてる
- 👎 ダメな点:ここの存在に気づくまで、かなりちゃんと理解しないと難しいな
- 👥 誰向けか:存在自体はバイブコーダー全ているんじゃないかな
