...
-クロードコート先に触ってると MD との使い分けに困るエージェントで動かそうとすると、なんか同じようなもの書いちゃってういろうとかも困るんで
-
-
...
- 🙂 第一印象:クロードドット MD と同じような感じかな
- 👍 良い点:平野エージェントに指示ができる
- 👎 ダメな点:どこまで入れるかが鍵だよね。クロードドット MD と同じように
- 👥 誰向けか:バイブコーダー全員じゃないかな
